...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("The Path must start at (0,0) and end at (1,1) start: ");
            outline24.append(this.f32mX[0]);
            outline24.append(",");
            outline24.append(this.f33mY[0]);
            outline24.append(" end:");
            int i6 = min - 1;
            outline24.append(this.f32mX[i6]);
            outline24.append(",");
            outline24.append(this.f33mY[i6]);
    ...
    private void parseInterpolatorFromTypeArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
            ...
            throw new InflateException(GeneratedOutlineSupport.outline16("The path is null, which is created from ", namedString));
    ...
    public float getInterpolation(float f) {
        ...
        float f3 = fArr2[i];
        return GeneratedOutlineSupport.outline0(fArr2[length], f3, (f - fArr[i]) / f2, f3);
    }
