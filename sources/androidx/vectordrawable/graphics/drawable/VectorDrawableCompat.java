...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder outline26 = GeneratedOutlineSupport.outline26(str, "current group is :");
        outline26.append(vGroup.getGroupName());
        outline26.append(" rotation is ");
        outline26.append(vGroup.mRotate);
        Log.v(LOGTAG, outline26.toString());
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                outline24.append(pathDataNodeArr[i].mType);
        ...
        public void printVPath(int i) {
            ...
            StringBuilder outline26 = GeneratedOutlineSupport.outline26(str, "current path is :");
            outline26.append(this.mPathName);
            outline26.append(" pathData is ");
            outline26.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, outline26.toString());
        }
