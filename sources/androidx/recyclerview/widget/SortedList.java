...
public class SortedList<T> {
    ...
    private void addToData(int i, T t) {
        ...
        StringBuilder outline25 = GeneratedOutlineSupport.outline25("cannot add item to ", i, " because size is ");
        outline25.append(this.mSize);
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        int i2;
        if (i >= this.mSize || i < 0) {
            StringBuilder outline25 = GeneratedOutlineSupport.outline25("Asked to get item at ", i, " but size is ");
            outline25.append(this.mSize);
            throw new IndexOutOfBoundsException(outline25.toString());
        }
