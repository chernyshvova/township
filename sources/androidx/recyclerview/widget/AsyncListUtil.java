...
public class AsyncListUtil<T> {
    ...
    public final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() {
        ...
        private void log(String str, Object... objArr) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("[BKGR] ");
            outline24.append(String.format(str, objArr));
            Log.d(AsyncListUtil.TAG, outline24.toString());
        }
    ...
    public final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>() {
        ...
        public void addTile(int i, TileList.Tile<T> tile) {
            ...
            if (addOrReplace != null) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("duplicate tile @");
                outline24.append(addOrReplace.mStartPosition);
                Log.e(AsyncListUtil.TAG, outline24.toString());
    ...
    public void log(String str, Object... objArr) {
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("[MAIN] ");
        outline24.append(String.format(str, objArr));
