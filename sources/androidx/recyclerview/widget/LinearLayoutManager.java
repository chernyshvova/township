...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("AnchorInfo{mPosition=");
            outline24.append(this.mPosition);
            outline24.append(", mCoordinate=");
            outline24.append(this.mCoordinate);
            outline24.append(", mLayoutFromEnd=");
            outline24.append(this.mLayoutFromEnd);
            outline24.append(", mValid=");
            outline24.append(this.mValid);
            outline24.append('}');
    ...
    public static class LayoutState {
        ...
        public void log() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("avail:");
            outline24.append(this.mAvailable);
            outline24.append(", ind:");
            outline24.append(this.mCurrentPosition);
            outline24.append(", dir:");
            outline24.append(this.mItemDirection);
            outline24.append(", offset:");
            outline24.append(this.mOffset);
            outline24.append(", layoutDir:");
    ...
    private void logChildren() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("item ");
            outline24.append(getPosition(childAt));
            outline24.append(", coord:");
            outline24.append(this.mOrientationHelper.getDecoratedStart(childAt));
            Log.d(TAG, outline24.toString());
        }
        Log.d(TAG, "==============");
    }
    ...
    public void setOrientation(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline14("invalid orientation:", i));
    }
    ...
    public void validateChildOrder() {
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("validating child count ");
        ...
        if (getChildCount() >= 1) {
            ...
            if (this.mShouldReverseLayout) {
                ...
                while (i < getChildCount()) {
                    ...
                    if (position2 < position) {
                        logChildren();
                        StringBuilder outline242 = GeneratedOutlineSupport.outline24("detected invalid position. loc invalid? ");
            ...
            while (i2 < getChildCount()) {
                ...
                if (position3 < position) {
                    logChildren();
                    StringBuilder outline243 = GeneratedOutlineSupport.outline24("detected invalid position. loc invalid? ");
