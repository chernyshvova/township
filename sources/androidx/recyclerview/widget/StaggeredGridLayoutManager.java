...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Provided int[]'s size must be more than or equal to span count. Expected:");
            outline24.append(this.mSpanCount);
            outline24.append(", array size:");
            outline24.append(iArr.length);
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("FullSpanItem{mPosition=");
                outline24.append(this.mPosition);
                outline24.append(", mGapDir=");
                outline24.append(this.mGapDir);
                outline24.append(", mHasUnwantedGapAfter=");
                outline24.append(this.mHasUnwantedGapAfter);
                outline24.append(", mGapPerSpan=");
                outline24.append(Arrays.toString(this.mGapPerSpan));
                outline24.append('}');
