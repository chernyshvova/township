...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    StringBuilder outline24 = GeneratedOutlineSupport.outline24("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    outline24.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(GeneratedOutlineSupport.outline13(this.mRecyclerView, outline24));
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(this.mRecyclerView, GeneratedOutlineSupport.outline24("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void offsetChildrenHorizontal(@C0030Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0030Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt != null) {
                ...
                if (findPositionOffset < 0 || findPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                    ...
                    throw new IndexOutOfBoundsException(GeneratedOutlineSupport.outline13(RecyclerView.this, sb));
                }
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(RecyclerView.this, GeneratedOutlineSupport.outline24("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            throw new IllegalStateException(GeneratedOutlineSupport.outline13(RecyclerView.this, sb));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Scrapped or attached views may not be recycled. isScrap:");
                outline24.append(viewHolder.isScrap());
                outline24.append(" isAttached:");
                if (viewHolder.itemView.getParent() != null) {
                    z = true;
                }
                outline24.append(z);
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(RecyclerView.this, outline24));
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(RecyclerView.this, sb));
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(RecyclerView.this, GeneratedOutlineSupport.outline24("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(RecyclerView.this, GeneratedOutlineSupport.outline24("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        }
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00b2:
                ...
                java.lang.String r1 = com.android.tools.p006r8.GeneratedOutlineSupport.outline13(r2, r1)
                r0.<init>(r1)
                throw r0
            L_0x00c4:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0030Px int i, @C0030Px int i2) {
            ...
            public void setDx(@C0030Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@C0030Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0030Px int i, @C0030Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
            ...
            public Action(@C0030Px int i, @C0030Px int i2, int i3) {
                this(i, i2, i3, (Interpolator) null);
            }

            public Action(@C0030Px int i, @C0030Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
            outline24.append(ScrollVectorProvider.class.getCanonicalName());
            Log.w(RecyclerView.TAG, outline24.toString());
            return null;
        }
        ...
        public abstract void onSeekTargetStep(@C0030Px int i, @C0030Px int i2, @NonNull State state, @NonNull Action action);
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("An instance of ");
                outline24.append(getClass().getSimpleName());
                outline24.append(" was started ");
                outline24.append("more than once. Each instance of");
                outline24.append(getClass().getSimpleName());
                outline24.append(" ");
                outline24.append("is intended to only be used once. You should create a new instance for ");
                outline24.append("each use.");
                Log.w(RecyclerView.TAG, outline24.toString());
            }
            this.mRecyclerView = recyclerView;
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            if ((this.mLayoutStep & i) == 0) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Layout state should be one of ");
                outline24.append(Integer.toBinaryString(i));
                outline24.append(" but it is ");
                outline24.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("State{mTargetPosition=");
            outline24.append(this.mTargetPosition);
            outline24.append(", mData=");
            outline24.append(this.mData);
            outline24.append(", mItemCount=");
            outline24.append(this.mItemCount);
            outline24.append(", mIsMeasuring=");
            outline24.append(this.mIsMeasuring);
            outline24.append(", mPreviousLayoutItemCount=");
            outline24.append(this.mPreviousLayoutItemCount);
            outline24.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            outline24.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            outline24.append(", mStructureChanged=");
            outline24.append(this.mStructureChanged);
            outline24.append(", mInPreLayout=");
            outline24.append(this.mInPreLayout);
            outline24.append(", mRunSimpleAnimations=");
            outline24.append(this.mRunSimpleAnimations);
            outline24.append(", mRunPredictiveAnimations=");
            outline24.append(this.mRunPredictiveAnimations);
            outline24.append('}');
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("ViewHolder{");
            outline24.append(Integer.toHexString(hashCode()));
            outline24.append(" position=");
            outline24.append(this.mPosition);
            outline24.append(" id=");
            outline24.append(this.mItemId);
            outline24.append(", oldPos=");
            outline24.append(this.mOldPosition);
            outline24.append(", pLpos:");
            outline24.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(outline24.toString());
            if (isScrap()) {
                sb.append(" scrap ");
            ...
            if (!isRecyclable()) {
                StringBuilder outline242 = GeneratedOutlineSupport.outline24(" not recyclable(");
                outline242.append(this.mIsRecyclableCount);
                outline242.append(")");
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(GeneratedOutlineSupport.outline13(this, sb));
                }
                ...
                throw new IllegalStateException(GeneratedOutlineSupport.outline13(this, sb2));
            }
        }
                    ...
                    if (i != 33) {
                        if (i != 66) {
                            if (i != 130) {
                                ...
                                sb.append(i);
                                throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(this, sb));
                            } else if (c > 0) {
                                return true;
                            } else {
                                return false;
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline13(this, GeneratedOutlineSupport.outline24("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(GeneratedOutlineSupport.outline13(this, GeneratedOutlineSupport.outline24(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(GeneratedOutlineSupport.outline13(this, GeneratedOutlineSupport.outline24("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(GeneratedOutlineSupport.outline13(this, GeneratedOutlineSupport.outline24(""))));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        outline24.append(super.toString());
        outline24.append(", adapter:");
        outline24.append(this.mAdapter);
        outline24.append(", layout:");
        outline24.append(this.mLayout);
        outline24.append(", context:");
        outline24.append(getContext());
        return outline24.toString();
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline13(this, GeneratedOutlineSupport.outline24("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(this, GeneratedOutlineSupport.outline24("Trying to set fast scroller without both required drawables.")));
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Error processing scroll; pointer index for id ");
                outline24.append(this.mScrollPointerId);
                outline24.append(" not found. Did any MotionEvents get skipped?");
    ...
    public void onScrolled(@C0030Px int i, @C0030Px int i2) {
    }
        ...
        if (layoutManager != this.mLayout) {
            ...
            if (layoutManager != null) {
                if (layoutManager.mRecyclerView == null) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline13(layoutManager.mRecyclerView, sb));
                }
            }
            this.mRecycler.updateViewCacheSize();
            requestLayout();
    ...
    public void smoothScrollBy(@C0030Px int i, @C0030Px int i2) {
    ...
    public void smoothScrollBy(@C0030Px int i, @C0030Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0391R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0391R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0391R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            boolean z2 = obtainStyledAttributes2.getBoolean(C0391R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z2;
            if (z2) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0391R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0391R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0391R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0391R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
