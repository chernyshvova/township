...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        private void dispatchAdditions(List<PostponedUpdate> list, ListUpdateCallback listUpdateCallback, int i, int i2, int i3) {
            ...
            for (int i4 = i2 - 1; i4 >= 0; i4--) {
                ...
                if (i6 == 0) {
                    ...
                    StringBuilder outline25 = GeneratedOutlineSupport.outline25("unknown flag for pos ", i5, " ");
                    outline25.append(Long.toBinaryString((long) i6));
        ...
        public int convertNewPositionToOld(@IntRange(from = 0) int i) {
            ...
            StringBuilder outline25 = GeneratedOutlineSupport.outline25("Index out of bounds - passed position = ", i, ", new list size = ");
            outline25.append(this.mNewItemStatuses.length);
        ...
        public int convertOldPositionToNew(@IntRange(from = 0) int i) {
            ...
            StringBuilder outline25 = GeneratedOutlineSupport.outline25("Index out of bounds - passed position = ", i, ", old list size = ");
            outline25.append(this.mOldItemStatuses.length);
            throw new IndexOutOfBoundsException(outline25.toString());
        }
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    ...
                    int i7 = snake.f23x;
                    if ((iArr[i7 + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(i7 + i6, 1, this.mCallback.getChangePayload(i7 + i6, snake.f24y + i6));
                    }
                }
                i = snake.f23x;
                i2 = snake.f24y;
    ...
    public static DiffResult calculateDiff(@NonNull Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f23x += range2.oldListStart;
                diffPartial.f24y += range2.newListStart;
                ...
                if (diffPartial.reverse) {
                    range.oldListEnd = diffPartial.f23x;
                    range.newListEnd = diffPartial.f24y;
                } else if (diffPartial.removal) {
                    range.oldListEnd = diffPartial.f23x - 1;
                    range.newListEnd = diffPartial.f24y;
                } else {
                    range.oldListEnd = diffPartial.f23x;
                    range.newListEnd = diffPartial.f24y - 1;
                }
                arrayList2.add(range);
                if (!diffPartial.reverse) {
                    int i2 = diffPartial.f23x;
                    int i3 = diffPartial.size;
                    range2.oldListStart = i2 + i3;
                    range2.newListStart = diffPartial.f24y + i3;
                } else if (diffPartial.removal) {
                    int i4 = diffPartial.f23x;
                    int i5 = diffPartial.size;
                    range2.oldListStart = i4 + i5 + 1;
                    range2.newListStart = diffPartial.f24y + i5;
                } else {
                    int i6 = diffPartial.f23x;
                    int i7 = diffPartial.size;
                    range2.oldListStart = i6 + i7;
                    range2.newListStart = diffPartial.f24y + i7 + 1;
                }
