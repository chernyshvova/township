...
public abstract class VersionedParcel {
        ...
        try {
            return (Serializable) new ObjectInputStream(new ByteArrayInputStream(readByteArray())) {
                public Class<?> resolveClass(ObjectStreamClass objectStreamClass) throws IOException, ClassNotFoundException {
                    Class<?> cls = Class.forName(objectStreamClass.getName(), false, C05391.class.getClassLoader());
                    if (cls != null) {
                        return cls;
                    }
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline17("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ")"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(GeneratedOutlineSupport.outline17("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ")"), e2);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline17("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
