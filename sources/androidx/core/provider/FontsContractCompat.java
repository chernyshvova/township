...
public class FontsContractCompat {
    ...
    public static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontsContractCompat.C01965.compare(byte[], byte[]):int");
        }
    };
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo281to = 1000) int i2, boolean z, int i3) {
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (resolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(GeneratedOutlineSupport.outline16("No package found for authority: ", providerAuthority));
            ...
            StringBuilder outline27 = GeneratedOutlineSupport.outline27("Found content provider ", providerAuthority, ", but package was not ");
            outline27.append(fontRequest.getProviderPackage());
            throw new PackageManager.NameNotFoundException(outline27.toString());
        }
    }
