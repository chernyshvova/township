                ...
                synchronized (this) {
                    if (!this.mLaunchingService) {
                        ...
                        if (!this.mServiceProcessing) {
                            this.mLaunchWakeLock.acquire(ConversationController.ACTIVE_ISSUE_NOTIFICATION_COUNT_TIMEOUT);
                        }
                    }
                }
            }
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder outline25 = GeneratedOutlineSupport.outline25("Given job ID ", i, " is different than previous ");
                outline25.append(this.mJobId);
