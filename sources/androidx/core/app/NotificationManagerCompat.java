...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            ...
            sb.append(", tag:");
            return GeneratedOutlineSupport.outline18(sb, this.tag, "]");
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerRecord) {
            ...
            if (bindService) {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Unable to bind to listener ");
                outline24.append(listenerRecord.componentName);
                Log.w(NotificationManagerCompat.TAG, outline24.toString());
        ...
        private void processListenerQueue(ListenerRecord listenerRecord) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Processing component ");
                outline24.append(listenerRecord.componentName);
                outline24.append(RESTClient.COMMA_SEPARATOR);
                outline24.append(listenerRecord.taskQueue.size());
                outline24.append(" queued tasks");
                Log.d(NotificationManagerCompat.TAG, outline24.toString());
            }
            if (!listenerRecord.taskQueue.isEmpty()) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                            StringBuilder outline242 = GeneratedOutlineSupport.outline24("Remote service has died: ");
                            outline242.append(listenerRecord.componentName);
                            Log.d(NotificationManagerCompat.TAG, outline242.toString());
                        }
                    } catch (RemoteException e) {
                        StringBuilder outline243 = GeneratedOutlineSupport.outline24("RemoteException communicating with ");
                        outline243.append(listenerRecord.componentName);
                        Log.w(NotificationManagerCompat.TAG, outline243.toString(), e);
                    }
                }
                if (!listenerRecord.taskQueue.isEmpty()) {
                    scheduleListenerRetry(listenerRecord);
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            if (!this.mHandler.hasMessages(3, listenerRecord.componentName)) {
                ...
                if (i > 6) {
                    StringBuilder outline24 = GeneratedOutlineSupport.outline24("Giving up on delivering ");
                    outline24.append(listenerRecord.taskQueue.size());
                    outline24.append(" tasks to ");
                    outline24.append(listenerRecord.componentName);
                    outline24.append(" after ");
                    outline24.append(listenerRecord.retryCount);
            ...
            if (!enabledListenerPackages.equals(this.mCachedEnabledPackages)) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (!hashSet.contains(next2.getKey())) {
                        if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Removing listener record for ");
                            outline24.append(next2.getKey());
                            Log.d(NotificationManagerCompat.TAG, outline24.toString());
                        }
    ...
    public NotificationManagerCompat(Context context) {
        this.mContext = context;
        this.mNotificationManager = (NotificationManager) context.getSystemService(SwrveNotificationConstants.PUSH_BUNDLE);
    }
