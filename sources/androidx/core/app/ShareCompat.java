...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Stream items available: ");
            outline24.append(getStreamCount());
            outline24.append(" index requested: ");
            outline24.append(i);
            throw new IndexOutOfBoundsException(outline24.toString());
        }
    }
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24(HISTORY_FILENAME_PREFIX);
        outline24.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(outline24.toString());
