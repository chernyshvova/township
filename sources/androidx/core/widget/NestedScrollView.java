...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("HorizontalScrollView.SavedState{");
            outline24.append(Integer.toHexString(System.identityHashCode(this)));
            outline24.append(" scrollPosition=");
            outline24.append(this.scrollPosition);
            outline24.append("}");
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    StringBuilder outline24 = GeneratedOutlineSupport.outline24("Invalid pointerId=");
                    outline24.append(this.mActivePointerId);
                    outline24.append(" in onTouchEvent");
