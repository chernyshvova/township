...
public final class TextViewCompat {
    ...
    public static int retrieveIntFromField(Field field, TextView textView) {
        try {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Could not retrieve value of ");
            outline24.append(field.getName());
            outline24.append(" field.");
            Log.d(LOG_TAG, outline24.toString());
            return -1;
        }
    }
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0030Px @IntRange(from = 0) int i) {
        int i2;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0030Px @IntRange(from = 0) int i) {
        int i2;
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0030Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
