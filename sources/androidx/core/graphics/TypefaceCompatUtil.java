...
public class TypefaceCompatUtil {
    ...
    public static File getTempFile(Context context) {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24(CACHE_FILE_PREFIX);
        outline24.append(Process.myPid());
        outline24.append("-");
        ...
        int i = 0;
        while (i < 100) {
            File file = new File(cacheDir, GeneratedOutlineSupport.outline14(sb, i));
            try {
