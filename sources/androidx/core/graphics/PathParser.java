...
public class PathParser {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline16("Error in parsing ", str), e);
        }
    }
    ...
    public static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline17("error in parsing \"", str, "\""), e);
        }
    }
    ...
    public static class PathDataNode {
        ...
        public static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d24 == RoundRectDrawableWithShadow.COS_45) {
                Log.w(PathParser.LOGTAG, " Points are coincident");
                return;
            }
            double d25 = (1.0d / d24) - 0.25d;
            if (d25 < RoundRectDrawableWithShadow.COS_45) {
            ...
            if (z4 != (atan22 >= RoundRectDrawableWithShadow.COS_45)) {
                atan22 = atan22 > RoundRectDrawableWithShadow.COS_45 ? atan22 - 6.283185307179586d : atan22 + 6.283185307179586d;
            }
            Double.isNaN(d7);
            double d28 = d2 * d7;
            Double.isNaN(d11);
