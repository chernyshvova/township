...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public TypefaceCompatApi26Impl() {
        ...
        try {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Unable to collect necessary methods for class ");
            outline24.append(e.getClass().getName());
    ...
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            ...
            try {
                openFileDescriptor = context.getContentResolver().openFileDescriptor(findBestInfo.getUri(), AnalyticsEventKey.SMART_INTENT_SEARCH_RANK, cancellationSignal);
