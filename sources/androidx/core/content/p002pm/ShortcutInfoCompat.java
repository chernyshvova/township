...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24(EXTRA_PERSON_);
                int i2 = i + 1;
                outline24.append(i2);
                persistableBundle.putPersistableBundle(outline24.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            ...
            int i3 = i2 + 1;
            outline24.append(i3);
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(outline24.toString()));
            i2 = i3;
        }
        return personArr;
    }
