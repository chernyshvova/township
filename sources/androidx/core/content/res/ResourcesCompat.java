...
public final class ResourcesCompat {
    ...
    public static float getFloat(@NonNull Resources resources, @DimenRes int i) {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("Resource ID #0x");
        outline24.append(Integer.toHexString(i));
        outline24.append(" type #0x");
        outline24.append(Integer.toHexString(typedValue.type));
        outline24.append(" is not valid");
        throw new Resources.NotFoundException(outline24.toString());
    }
    ...
    public static Typeface loadFont(@NonNull Context context, int i, TypedValue typedValue, int i2, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z) {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("Font resource ID #0x");
        outline24.append(Integer.toHexString(i));
        outline24.append(" could not be retrieved.");
        throw new Resources.NotFoundException(outline24.toString());
    }
