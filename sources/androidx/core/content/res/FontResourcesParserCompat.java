...
public class FontResourcesParserCompat {
    ...
    public static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0162R.styleable.FontFamily);
        String string = obtainAttributes.getString(C0162R.styleable.FontFamily_fontProviderAuthority);
        String string2 = obtainAttributes.getString(C0162R.styleable.FontFamily_fontProviderPackage);
        String string3 = obtainAttributes.getString(C0162R.styleable.FontFamily_fontProviderQuery);
        int resourceId = obtainAttributes.getResourceId(C0162R.styleable.FontFamily_fontProviderCerts, 0);
        int integer = obtainAttributes.getInteger(C0162R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int integer2 = obtainAttributes.getInteger(C0162R.styleable.FontFamily_fontProviderFetchTimeout, 500);
    ...
    public static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i4;
        int i5;
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0162R.styleable.FontFamilyFont);
        if (obtainAttributes.hasValue(C0162R.styleable.FontFamilyFont_fontWeight)) {
            i = C0162R.styleable.FontFamilyFont_fontWeight;
        } else {
            i = C0162R.styleable.FontFamilyFont_android_fontWeight;
        }
        int i6 = obtainAttributes.getInt(i, 400);
        if (obtainAttributes.hasValue(C0162R.styleable.FontFamilyFont_fontStyle)) {
            i2 = C0162R.styleable.FontFamilyFont_fontStyle;
        } else {
            i2 = C0162R.styleable.FontFamilyFont_android_fontStyle;
        }
        boolean z = 1 == obtainAttributes.getInt(i2, 0);
        if (obtainAttributes.hasValue(C0162R.styleable.FontFamilyFont_ttcIndex)) {
            i3 = C0162R.styleable.FontFamilyFont_ttcIndex;
        } else {
            i3 = C0162R.styleable.FontFamilyFont_android_ttcIndex;
        }
        if (obtainAttributes.hasValue(C0162R.styleable.FontFamilyFont_fontVariationSettings)) {
            i4 = C0162R.styleable.FontFamilyFont_fontVariationSettings;
        } else {
            i4 = C0162R.styleable.FontFamilyFont_android_fontVariationSettings;
        }
        String string = obtainAttributes.getString(i4);
        int i7 = obtainAttributes.getInt(i3, 0);
        if (obtainAttributes.hasValue(C0162R.styleable.FontFamilyFont_font)) {
            i5 = C0162R.styleable.FontFamilyFont_font;
        } else {
            i5 = C0162R.styleable.FontFamilyFont_android_font;
        }
