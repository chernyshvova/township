...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public void onLoadChildren(String str, final ResultWrapper<List<Parcel>> resultWrapper) {
            C03622 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
                public void detach() {
        ...
        public void setSessionToken(final MediaSessionCompat.Token token) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    MediaBrowserServiceImplApi21.this.mServiceFwk.setSessionToken((MediaSession.Token) token.mInner);
                }
            });
        }
    ...
    public class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 {
        ...
        public void onLoadItem(String str, final ResultWrapper<Parcel> resultWrapper) {
            C03651 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
                public void detach() {
                    resultWrapper.detach();
                }
    ...
    public class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 {
        ...
        public void onLoadChildren(String str, final ResultWrapper<List<Parcel>> resultWrapper, final Bundle bundle) {
            C03661 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
                public void detach() {
                    resultWrapper.detach();
                }
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Connection for ");
                            outline24.append(next.pkg);
                            outline24.append(" is no longer valid.");
                            Log.w(MediaBrowserServiceCompat.TAG, outline24.toString());
                            it.remove();
                        }
                    }
                }
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("detach() called when detach() had already been called for: ");
                outline24.append(this.mDebug);
                throw new IllegalStateException(outline24.toString());
            } else if (this.mSendResultCalled) {
                StringBuilder outline242 = GeneratedOutlineSupport.outline24("detach() called when sendResult() had already been called for: ");
                outline242.append(this.mDebug);
                throw new IllegalStateException(outline242.toString());
            } else if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder outline243 = GeneratedOutlineSupport.outline24("detach() called when sendError() had already been called for: ");
                outline243.append(this.mDebug);
                throw new IllegalStateException(outline243.toString());
            }
        }
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("It is not supported to send an error for ");
            outline24.append(this.mDebug);
            throw new UnsupportedOperationException(outline24.toString());
        }

        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("It is not supported to send an interim update for ");
            outline24.append(this.mDebug);
            throw new UnsupportedOperationException(outline24.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("sendError() called when either sendResult() or sendError() had already been called for: ");
                outline24.append(this.mDebug);
                throw new IllegalStateException(outline24.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                outline24.append(this.mDebug);
                throw new IllegalStateException(outline24.toString());
            }
        ...
        public void sendResult(T t) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("sendResult() called when either sendResult() or sendError() had already been called for: ");
                outline24.append(this.mDebug);
                throw new IllegalStateException(outline24.toString());
            }
        ...
        public void addSubscription(String str, IBinder iBinder, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        StringBuilder outline24 = GeneratedOutlineSupport.outline24("addSubscription for callback that isn't registered id=");
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i2)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        mediaBrowserServiceCompat2.mCurConnection = null;
                        if (onGetRoot == null) {
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("No root for client ");
                            outline24.append(str2);
                            outline24.append(" from service ");
                            outline24.append(C03701.class.getName());
                            Log.i(MediaBrowserServiceCompat.TAG, outline24.toString());
                            try {
                                serviceCallbacks2.onConnectFailed();
                            } catch (RemoteException unused) {
                                StringBuilder outline242 = GeneratedOutlineSupport.outline24("Calling onConnectFailed() failed. Ignoring. pkg=");
                                outline242.append(str2);
                                Log.w(MediaBrowserServiceCompat.TAG, outline242.toString());
                            }
                        } else {
                            try {
                                ...
                                StringBuilder outline243 = GeneratedOutlineSupport.outline24("Calling onConnect() failed. Dropping client. pkg=");
                                outline243.append(str2);
                                Log.w(MediaBrowserServiceCompat.TAG, outline243.toString());
                                MediaBrowserServiceCompat.this.mConnections.remove(asBinder);
                            }
                        }
                    }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (connectionRecord == null) {
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("getMediaItem for callback that isn't registered id=");
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                    if (connectionRecord == null) {
                        StringBuilder outline24 = GeneratedOutlineSupport.outline24("removeSubscription for callback that isn't registered id=");
                        outline24.append(str);
                        Log.w(MediaBrowserServiceCompat.TAG, outline24.toString());
                    } else if (!MediaBrowserServiceCompat.this.removeSubscription(str, connectionRecord, iBinder)) {
                        StringBuilder outline242 = GeneratedOutlineSupport.outline24("removeSubscription called for ");
                        outline242.append(str);
                        outline242.append(" which is not subscribed");
                        Log.w(MediaBrowserServiceCompat.TAG, outline242.toString());
                    }
                }
            });
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("search for callback that isn't registered query=");
                            outline24.append(str2);
                            Log.w(MediaBrowserServiceCompat.TAG, outline24.toString());
                            return;
                        }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("sendCustomAction for callback that isn't registered action=");
                            outline24.append(str2);
                            outline24.append(", extras=");
                            outline24.append(bundle2);
                            Log.w(MediaBrowserServiceCompat.TAG, outline24.toString());
                            return;
                        }
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03594 r0 = new Result<Bundle>(str) {
            public void onErrorSent(Bundle bundle) {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        C03561 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord2.callbacks.asBinder()) == connectionRecord2) {
                    ...
                    try {
                        ...
                        StringBuilder outline24 = GeneratedOutlineSupport.outline24("Calling onLoadChildren() failed for id=");
                        outline24.append(str2);
                        outline24.append(" package=");
                        outline24.append(connectionRecord2.pkg);
                        Log.w(MediaBrowserServiceCompat.TAG, outline24.toString());
                    }
                } else if (MediaBrowserServiceCompat.DEBUG) {
                    StringBuilder outline242 = GeneratedOutlineSupport.outline24("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
                    outline242.append(connectionRecord2.pkg);
                    outline242.append(" id=");
                    outline242.append(str2);
                    Log.d(MediaBrowserServiceCompat.TAG, outline242.toString());
                }
            }
        };
        this.mCurConnection = connectionRecord;
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline19(GeneratedOutlineSupport.outline24("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }

    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03572 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline16("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }

    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C03583 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
        ...
        this.mCurConnection = null;
        if (!r0.isDone()) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline16("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
