...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i, int i2, @C0030Px int i3, @C0030Px int i4) {
        }
    ...
    public void captureChildView(@NonNull View view, int i) {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        outline24.append(this.mParentView);
        outline24.append(")");
