...
public class InvalidationTracker {
    ...
    public static void appendTriggerName(StringBuilder sb, String str, String str2) {
        GeneratedOutlineSupport.outline34(sb, "`", "room_table_modification_trigger_", str, "_");
        sb.append(str2);
        sb.append("`");
    }
    ...
    private void startTrackingTable(SupportSQLiteDatabase supportSQLiteDatabase, int i) {
        ...
        for (String str2 : TRIGGERS) {
            ...
            sb.append(str2);
            sb.append(" ON `");
            GeneratedOutlineSupport.outline34(sb, str, "` BEGIN UPDATE ", UPDATE_TABLE_NAME, " SET ");
            GeneratedOutlineSupport.outline34(sb, INVALIDATED_COLUMN_NAME, " = 1", " WHERE ", TABLE_ID_COLUMN_NAME);
            sb.append(" = ");
            sb.append(i);
            sb.append(" AND ");
    ...
    private String[] validateAndResolveTableNames(String[] strArr) {
        ...
        while (i < length) {
            ...
            if (this.mTableIdLookup.containsKey(str.toLowerCase(Locale.US))) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline16("There is no table with name ", str));
            }
        }
        return resolveViews;
    }
    ...
    public void addObserver(@NonNull Observer observer) {
        ...
        while (i < length) {
            ...
            if (num != null) {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("There is no table with name ");
                outline24.append(resolveViews[i]);
