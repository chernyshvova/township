...
public class TableInfo {
    ...
    public static class Column {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Column{name='");
            GeneratedOutlineSupport.outline33(outline24, this.name, '\'', ", type='");
            GeneratedOutlineSupport.outline33(outline24, this.type, '\'', ", affinity='");
            outline24.append(this.affinity);
            outline24.append('\'');
            outline24.append(", notNull=");
            outline24.append(this.notNull);
            outline24.append(", primaryKeyPosition=");
            outline24.append(this.primaryKeyPosition);
            outline24.append(", defaultValue='");
            outline24.append(this.defaultValue);
            outline24.append('\'');
            outline24.append('}');
    ...
    public static class ForeignKey {
        ...
        public int hashCode() {
            int outline4 = GeneratedOutlineSupport.outline4(this.onUpdate, GeneratedOutlineSupport.outline4(this.onDelete, this.referenceTable.hashCode() * 31, 31), 31);
            return this.referenceColumnNames.hashCode() + ((this.columnNames.hashCode() + outline4) * 31);
        }

        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("ForeignKey{referenceTable='");
            GeneratedOutlineSupport.outline33(outline24, this.referenceTable, '\'', ", onDelete='");
            GeneratedOutlineSupport.outline33(outline24, this.onDelete, '\'', ", onUpdate='");
            GeneratedOutlineSupport.outline33(outline24, this.onUpdate, '\'', ", columnNames=");
            outline24.append(this.columnNames);
            outline24.append(", referenceColumnNames=");
            outline24.append(this.referenceColumnNames);
            outline24.append('}');
            return outline24.toString();
        }
    }
    ...
    public static class Index {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Index{name='");
            GeneratedOutlineSupport.outline33(outline24, this.name, '\'', ", unique=");
            outline24.append(this.unique);
    ...
    public String toString() {
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("TableInfo{name='");
        GeneratedOutlineSupport.outline33(outline24, this.name, '\'', ", columns=");
        outline24.append(this.columns);
        outline24.append(", foreignKeys=");
        outline24.append(this.foreignKeys);
        outline24.append(", indices=");
        outline24.append(this.indices);
        outline24.append('}');
        return outline24.toString();
    }
