...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Rect should be within the child's bounds. Rect:");
                outline24.append(acquireTempRect.toShortString());
                outline24.append(" | Bounds:");
                outline24.append(acquireTempRect2.toShortString());
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline16("Could not inflate Behavior subclass ", str), e);
        }
    }
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        StringBuilder outline24 = GeneratedOutlineSupport.outline24("Default behavior class ");
                        outline24.append(defaultBehavior.value().getName());
                        outline24.append(" could not be instantiated. Did you forget");
                        outline24.append(" a default constructor?");
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById != null) {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Could not find CoordinatorLayout descendant view with id ");
                outline24.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                outline24.append(" to anchor view ");
                outline24.append(view);
