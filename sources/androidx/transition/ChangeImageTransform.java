...
public class ChangeImageTransform extends Transition {
    ...
    public static /* synthetic */ class C04973 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C04973.<clinit>():void");
        }
    }
    ...
    public static Matrix copyImageMatrix(ImageView imageView) {
        int i = C04973.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        if (i == 1) {
