...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        if (i == 0) {
            ...
            throw new AndroidRuntimeException(GeneratedOutlineSupport.outline14("Invalid parameter for TransitionSet ordering: ", i));
        }
        return this;
    }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder outline26 = GeneratedOutlineSupport.outline26(transition, "\n");
            outline26.append(this.mTransitions.get(i).toString(str + "  "));
            transition = outline26.toString();
        }
        return transition;
    }
