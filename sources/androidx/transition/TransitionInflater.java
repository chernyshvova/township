...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class cls, String str) {
        ...
        if (attributeValue != null) {
            ...
            throw new InflateException(GeneratedOutlineSupport.outline16(str, " tag must have a 'class' attribute"));
        }
    }
                ...
                if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                    if (next == 2) {
                        ...
                        if ("fade".equals(name)) {
                            ...
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Unknown scene name: ");
                            outline24.append(xmlPullParser.getName());
                                ...
                                if (namedString2 != null) {
                                    ...
                                    if (namedString3 != null) {
                                        try {
                                            ...
                                            throw new RuntimeException(GeneratedOutlineSupport.outline16("Could not create ", namedString3), e);
                                        }
                                    } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        if (namedResourceId >= 0 && (inflateTransition = inflateTransition(namedResourceId)) != null) {
            if (scene2 == null) {
                throw new RuntimeException(GeneratedOutlineSupport.outline14("No toScene for transition ID ", namedResourceId));
            } else if (scene == null) {
