...
public class Scene {
    ...
    public static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0509R.C0511id.transition_current_scene);
    }

    @NonNull
    public static Scene getSceneForLayout(@NonNull ViewGroup viewGroup, @LayoutRes int i, @NonNull Context context) {
        SparseArray sparseArray = (SparseArray) viewGroup.getTag(C0509R.C0511id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            viewGroup.setTag(C0509R.C0511id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    public static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0509R.C0511id.transition_current_scene, scene);
    }
