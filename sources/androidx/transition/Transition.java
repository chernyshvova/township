...
public abstract class Transition implements Cloneable {
    ...
    public static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if ("id".equalsIgnoreCase(trim)) {
                ...
                throw new InflateException(GeneratedOutlineSupport.outline17("Unknown match type in matchOrder: '", trim, "'"));
            }
            i++;
        }
        return iArr;
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            StringBuilder outline26 = GeneratedOutlineSupport.outline26(sb, "dur(");
            outline26.append(this.mDuration);
            outline26.append(") ");
            sb = outline26.toString();
        }
        if (this.mStartDelay != -1) {
            StringBuilder outline262 = GeneratedOutlineSupport.outline26(sb, "dly(");
            outline262.append(this.mStartDelay);
            outline262.append(") ");
            sb = outline262.toString();
        }
        if (this.mInterpolator != null) {
            StringBuilder outline263 = GeneratedOutlineSupport.outline26(sb, "interp(");
            outline263.append(this.mInterpolator);
            outline263.append(") ");
        ...
        String outline16 = GeneratedOutlineSupport.outline16(sb, "tgts(");
        if (this.mTargetIds.size() > 0) {
            for (int i = 0; i < this.mTargetIds.size(); i++) {
                if (i > 0) {
                    outline16 = GeneratedOutlineSupport.outline16(outline16, RESTClient.COMMA_SEPARATOR);
                }
                StringBuilder outline242 = GeneratedOutlineSupport.outline24(outline16);
                outline242.append(this.mTargetIds.get(i));
                outline16 = outline242.toString();
            }
        }
        if (this.mTargets.size() > 0) {
            for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                ...
                StringBuilder outline243 = GeneratedOutlineSupport.outline24(outline16);
                outline243.append(this.mTargets.get(i2));
                outline16 = outline243.toString();
            }
        }
        return GeneratedOutlineSupport.outline16(outline16, ")");
    }
