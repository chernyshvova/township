...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(GeneratedOutlineSupport.outline16(str, "  "), fileDescriptor, printWriter, strArr);
    ...
    public static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D d) {
            if (LoaderManagerImpl.DEBUG) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("  onLoadFinished in ");
                outline24.append(this.mLoader);
                outline24.append(": ");
                outline24.append(this.mLoader.dataToString(d));
                Log.v(LoaderManagerImpl.TAG, outline24.toString());
            }
        ...
        public void reset() {
            if (this.mDeliveredData) {
                if (LoaderManagerImpl.DEBUG) {
                    StringBuilder outline24 = GeneratedOutlineSupport.outline24("  Resetting: ");
                    outline24.append(this.mLoader);
                    Log.v(LoaderManagerImpl.TAG, outline24.toString());
                }
