...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float f) {
        ...
        double d = (double) min;
        Double.isNaN(d);
        float max = (((float) Math.max(d - 0.4d, RoundRectDrawableWithShadow.COS_45)) * 5.0f) / 3.0f;
    ...
    public void setSlingshotDistance(@C0030Px int i) {
