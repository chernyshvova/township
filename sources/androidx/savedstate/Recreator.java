        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport.outline16("Failed to instantiate ", str), e);
                }
            } catch (NoSuchMethodException e2) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Class");
                outline24.append(asSubclass.getSimpleName());
                outline24.append(" must have default constructor in order to be automatically recreated");
                throw new IllegalStateException(outline24.toString(), e2);
            }
        } catch (ClassNotFoundException e3) {
            throw new RuntimeException(GeneratedOutlineSupport.outline17("Class ", str, " wasn't found"), e3);
        }
    }
