...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("SearchView.SavedState{");
            outline24.append(Integer.toHexString(System.identityHashCode(this)));
            outline24.append(" isIconified=");
            outline24.append(this.isIconified);
            outline24.append("}");
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                i = resources.getDimensionPixelSize(C0032R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0032R.dimen.abc_dropdownitem_icon_width);
            } else {
                i = 0;
            }
