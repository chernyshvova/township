...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i) {
        ...
        float dimension = obtainStyledAttributes.hasValue(C0032R.styleable.AppCompatTextView_autoSizeStepGranularity) ? obtainStyledAttributes.getDimension(C0032R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f) : -1.0f;
        float dimension2 = obtainStyledAttributes.hasValue(C0032R.styleable.AppCompatTextView_autoSizeMinTextSize) ? obtainStyledAttributes.getDimension(C0032R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f) : -1.0f;
        float dimension3 = obtainStyledAttributes.hasValue(C0032R.styleable.AppCompatTextView_autoSizeMaxTextSize) ? obtainStyledAttributes.getDimension(C0032R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f) : -1.0f;
        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    StringBuilder outline24 = GeneratedOutlineSupport.outline24("None of the preset sizes is valid: ");
                    outline24.append(Arrays.toString(iArr));
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        ...
        if (i == 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline14("Unknown auto-size text type: ", i));
        }
    }
