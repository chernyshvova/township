...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            StringBuilder outline26 = GeneratedOutlineSupport.outline26("[", "resolveInfo:");
            outline26.append(this.resolveInfo.toString());
            outline26.append("; weight:");
            outline26.append(new BigDecimal((double) this.weight));
            outline26.append("]");
    ...
    public final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            /*
                ...
                r6 = 0
                androidx.appcompat.widget.ActivityChooserModel r7 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x00df }
                android.content.Context r7 = r7.mContext     // Catch:{ FileNotFoundException -> 0x00df }
                java.io.FileOutputStream r15 = r7.openFileOutput(r15, r3)     // Catch:{ FileNotFoundException -> 0x00df }
                org.xmlpull.v1.XmlSerializer r7 = android.util.Xml.newSerializer()
                r7.setOutput(r15, r6)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r8 = "UTF-8"
                java.lang.Boolean r9 = java.lang.Boolean.TRUE     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.startDocument(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.startTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                int r8 = r4.size()     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r9 = 0
            L_0x002f:
                if (r9 >= r8) goto L_0x0062
                java.lang.Object r10 = r4.remove(r3)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r10 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r10     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.startTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r11 = "activity"
                android.content.ComponentName r12 = r10.activity     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r12 = r12.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r11 = "time"
                long r12 = r10.time     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r12 = java.lang.String.valueOf(r12)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r11 = "weight"
                float r10 = r10.weight     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.attribute(r6, r11, r10)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.endTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                int r9 = r9 + 1
                goto L_0x002f
            L_0x0062:
                r7.endTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
                r7.endDocument()     // Catch:{ IllegalArgumentException -> 0x00b4, IllegalStateException -> 0x0094, IOException -> 0x0074 }
            ...
            L_0x0074:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0072 }
                ...
                androidx.appcompat.widget.ActivityChooserModel r2 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0072 }
                java.lang.String r2 = r2.mHistoryFileName     // Catch:{ all -> 0x0072 }
                r3.append(r2)     // Catch:{ all -> 0x0072 }
                java.lang.String r2 = r3.toString()     // Catch:{ all -> 0x0072 }
                android.util.Log.e(r1, r2, r0)     // Catch:{ all -> 0x0072 }
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r5
                if (r15 == 0) goto L_0x00d4
                goto L_0x006e
            ...
            L_0x00d5:
                ...
                r15.close()     // Catch:{ IOException -> 0x00de }
            L_0x00de:
                throw r0
            L_0x00df:
                r0 = move-exception
    ...
    public ActivityChooserModel(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str) || str.endsWith(HISTORY_FILE_EXTENSION)) {
            ...
            this.mHistoryFileName = GeneratedOutlineSupport.outline16(str, HISTORY_FILE_EXTENSION);
        }
    }
