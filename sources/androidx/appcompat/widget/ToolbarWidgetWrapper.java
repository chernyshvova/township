...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            this.mSpinner = new AppCompatSpinner(getContext(), (AttributeSet) null, C0032R.attr.actionDropDownStyle);
    ...
    public void setNavigationMode(int i) {
        ...
        if (i != i2) {
            ...
            if (i == 1) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline14("Invalid navigation mode ", i));
            }
        }
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), (AttributeSet) null, C0032R.styleable.ActionBar, C0032R.attr.actionBarStyle, 0);
