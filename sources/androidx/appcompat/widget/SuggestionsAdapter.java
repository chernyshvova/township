...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder outline25 = GeneratedOutlineSupport.outline25("Invalid icon resource ", iconResource, " for ");
            outline25.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, outline25.toString());
            return null;
