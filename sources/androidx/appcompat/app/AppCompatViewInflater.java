...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            if (id == -1) {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24(" with id '");
                outline24.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                outline24.append("'");
                str = outline24.toString();
            }
            StringBuilder outline242 = GeneratedOutlineSupport.outline24("Could not find method ");
            outline242.append(this.mMethodName);
            outline242.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
            outline242.append(this.mHostView.getClass());
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        if (str.equals(ViewHierarchyConstants.VIEW_KEY)) {
            str = attributeSet.getAttributeValue((String) null, FacebookAppLinkResolver.APP_LINK_TARGET_CLASS_KEY);
        }
        try {
