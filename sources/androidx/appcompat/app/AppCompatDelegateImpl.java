...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0032R.layout.abc_list_menu_item_layout);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0032R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0032R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0032R.layout.abc_screen_simple, (ViewGroup) null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0032R.layout.abc_screen_toolbar, (ViewGroup) null);
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("AppCompat does not support the current theme features: { windowActionBar: ");
            outline24.append(this.mHasActionBar);
            outline24.append(", windowActionBarOverlay: ");
            outline24.append(this.mOverlayActionBar);
            outline24.append(", android:windowIsFloating: ");
            outline24.append(this.mIsFloating);
            outline24.append(", windowActionModeOverlay: ");
            outline24.append(this.mOverlayActionMode);
            outline24.append(", windowNoTitle: ");
            outline24.append(this.mWindowNoTitle);
            outline24.append(" }");
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0032R.color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0032R.color.abc_decor_view_status_guard);
        }
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        try {
            ...
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0032R.style.Theme_AppCompat_Empty);
