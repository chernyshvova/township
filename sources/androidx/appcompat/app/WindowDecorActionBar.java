...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("Can't make a decor toolbar out of ");
        outline24.append(view != null ? view.getClass().getSimpleName() : "null");
    ...
    private void init(View view) {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes((AttributeSet) null, C0032R.styleable.ActionBar, C0032R.attr.actionBarStyle, 0);
