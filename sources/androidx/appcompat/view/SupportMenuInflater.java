...
public class SupportMenuInflater extends MenuInflater {
    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                StringBuilder outline27 = GeneratedOutlineSupport.outline27("Couldn't resolve menu item onClick handler ", str, " in class ");
                outline27.append(cls.getName());
                InflateException inflateException = new InflateException(outline27.toString());
    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (obtainStyledAttributes.getInt(C0032R.styleable.MenuItem_android_menuCategory, this.groupCategory) & SupportMenu.CATEGORY_MASK) | (obtainStyledAttributes.getInt(C0032R.styleable.MenuItem_android_orderInCategory, this.groupOrder) & SupportMenu.USER_MASK);
        ...
        while (true) {
            if (eventType != 2) {
                ...
                if (name.equals(XML_MENU)) {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport.outline16("Expecting menu, got ", name));
                }
            }
        }
        boolean z = false;
