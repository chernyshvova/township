...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0032R.styleable.DrawerArrowToggle, C0032R.attr.drawerArrowStyle, C0032R.style.Base_Widget_AppCompat_DrawerArrowToggle);
    ...
    public void setProgress(@FloatRange(from = 0.0d, mo263to = 1.0d) float f) {
        if (this.mProgress != f) {
            this.mProgress = f;
            invalidateSelf();
        }
