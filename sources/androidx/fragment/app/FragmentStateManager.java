...
public class FragmentStateManager {
    ...
    public static /* synthetic */ class C02862 {
        ...
        static {
            ...
            L_0x0023:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C02862.<clinit>():void");
        }
    }
    ...
    public void activityCreated() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("moveto ACTIVITY_CREATED: ");
    ...
    public void attach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("moveto ATTACHED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
        Fragment fragment = this.mFragment;
        ...
        if (fragment2 != null) {
            ...
            if (fragmentStateManager2 != null) {
                ...
                StringBuilder outline242 = GeneratedOutlineSupport.outline24("Fragment ");
                outline242.append(this.mFragment);
                outline242.append(" declared target fragment ");
                outline242.append(this.mFragment.mTarget);
                outline242.append(" that does not belong to this FragmentManager!");
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                StringBuilder outline243 = GeneratedOutlineSupport.outline24("Fragment ");
                outline243.append(this.mFragment);
                outline243.append(" declared target fragment ");
                throw new IllegalStateException(GeneratedOutlineSupport.outline18(outline243, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder outline25 = GeneratedOutlineSupport.outline25("computeExpectedState() of ", i, " for ");
            outline25.append(this.mFragment);
            Log.v("FragmentManager", outline25.toString());
        }
        return i;
    }
    ...
    public void create() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("moveto CREATED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
        Fragment fragment = this.mFragment;
    ...
    public void createView() {
        ...
        if (!this.mFragment.mFromLayout) {
            if (FragmentManager.isLoggingEnabled(3)) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("moveto CREATE_VIEW: ");
                outline24.append(this.mFragment);
                Log.d("FragmentManager", outline24.toString());
            }
            Fragment fragment = this.mFragment;
                    ...
                    if (i != -1) {
                        ...
                        if (viewGroup == null) {
                            ...
                            if (!fragment3.mRestored) {
                                ...
                                StringBuilder outline242 = GeneratedOutlineSupport.outline24("No view found for id 0x");
                                outline242.append(Integer.toHexString(this.mFragment.mContainerId));
                                outline242.append(" (");
                                outline242.append(str);
                                outline242.append(") for fragment ");
                                outline242.append(this.mFragment);
                                throw new IllegalArgumentException(outline242.toString());
                            }
                        }
                    } else {
                        StringBuilder outline243 = GeneratedOutlineSupport.outline24("Cannot create fragment ");
                        outline243.append(this.mFragment);
                        outline243.append(" for a container view with no id");
            ...
            if (view != null) {
                ...
                Fragment fragment5 = this.mFragment;
                fragment5.mView.setTag(C0234R.C0236id.fragment_container_view_tag, fragment5);
                if (viewGroup != null) {
                    addViewToContainer();
                }
    ...
    public void destroy() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("movefrom CREATED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
        Fragment fragment = this.mFragment;
    ...
    public void destroyFragmentView() {
        View view;
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("movefrom CREATE_VIEW: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
        Fragment fragment = this.mFragment;
    ...
    public void detach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("movefrom ATTACHED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
        ...
        if (z || this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
            if (FragmentManager.isLoggingEnabled(3)) {
                StringBuilder outline242 = GeneratedOutlineSupport.outline24("initState called for fragment: ");
                outline242.append(this.mFragment);
                Log.d("FragmentManager", outline242.toString());
            }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C0234R.C0236id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
    ...
    public void moveToExpectedState() {
        if (!this.mMovingToState) {
            ...
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Ignoring re-entrant call to moveToExpectedState() for ");
            outline24.append(getFragment());
    ...
    public void pause() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("movefrom RESUMED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
    ...
    public void resume() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("moveto RESUMED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
    ...
    public void start() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("moveto STARTED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
    ...
    public void stop() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("movefrom STARTED: ");
            outline24.append(this.mFragment);
            Log.d("FragmentManager", outline24.toString());
        }
    ...
    public FragmentStateManager(@NonNull FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher, @NonNull FragmentStore fragmentStore, @NonNull ClassLoader classLoader, @NonNull FragmentFactory fragmentFactory, @NonNull FragmentState fragmentState) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Instantiated fragment ");
            outline24.append(this.mFragment);
            Log.v("FragmentManager", outline24.toString());
        }
    }
