        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (FragmentStateManager next : this.mActive.values()) {
                ...
                if (next != null) {
                    ...
                    fragment.dump(outline16, fileDescriptor, printWriter, strArr);
                } else {
        ...
        if (list != null) {
            for (String next : list) {
                ...
                if (findActiveFragment != null) {
                    ...
                    throw new IllegalStateException(GeneratedOutlineSupport.outline17("No instantiated fragment for (", next, ")"));
                }
            }
        }
    }
