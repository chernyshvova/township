...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("FragmentTabHost.SavedState{");
            outline24.append(Integer.toHexString(System.identityHashCode(this)));
            outline24.append(" curTab=");
            return GeneratedOutlineSupport.outline18(outline24, this.curTab, "}");
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            if (frameLayout == null) {
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("No tab content FrameLayout found for id ");
                outline24.append(this.mContainerId);
