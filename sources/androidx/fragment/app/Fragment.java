...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull Function<Void, ActivityResultRegistry> function, @NonNull ActivityResultCallback<O> activityResultCallback) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
    }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() {
            ...
            public View onFindViewById(int i) {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Fragment ");
                outline24.append(Fragment.this);
                outline24.append(" does not have a view");
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(GeneratedOutlineSupport.outline16(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public String generateActivityResultKey() {
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("fragment_");
        outline24.append(this.mWho);
        outline24.append("_rq#");
        outline24.append(this.mNextLocalRequestCode.getAndIncrement());
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " has not been attached yet."));
    }
        ...
        if (this.mFragmentManager != null) {
            if (this.mDefaultFactory == null) {
                ...
                if (application == null && FragmentManager.isLoggingEnabled(3)) {
                    StringBuilder outline24 = GeneratedOutlineSupport.outline24("Could not find Application instance from Context ");
                    outline24.append(requireContext().getApplicationContext());
                    outline24.append(", you will not be able to use AndroidViewModel with the default ViewModelProvider.Factory");
                    Log.d("FragmentManager", outline24.toString());
                }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onAttach()"));
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onDestroyView()"));
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onDetach()"));
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(GeneratedOutlineSupport.outline15("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline15("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(GeneratedOutlineSupport.outline17("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (IllegalAccessException e2) {
            throw new InstantiationException(GeneratedOutlineSupport.outline17("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(GeneratedOutlineSupport.outline17("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(GeneratedOutlineSupport.outline17("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
