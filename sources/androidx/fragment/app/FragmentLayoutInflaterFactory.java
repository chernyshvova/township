...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        String attributeValue = attributeSet.getAttributeValue((String) null, FacebookAppLinkResolver.APP_LINK_TARGET_CLASS_KEY);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0234R.styleable.Fragment);
        if (attributeValue == null) {
            attributeValue = obtainStyledAttributes.getString(C0234R.styleable.Fragment_android_name);
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0234R.styleable.Fragment_android_id, -1);
        String string = obtainStyledAttributes.getString(C0234R.styleable.Fragment_android_tag);
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline17("Fragment ", attributeValue, " did not create a view."));
    }
}
