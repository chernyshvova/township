...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(@NonNull ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        HashSet hashSet = new HashSet();
        while (i < i2) {
            Iterator<FragmentTransaction.C0288Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
    ...
    private void executeOpsTogether(@androidx.annotation.NonNull java.util.ArrayList<androidx.fragment.app.BackStackRecord> r18, @androidx.annotation.NonNull java.util.ArrayList<java.lang.Boolean> r19, int r20, int r21) {
        ...
        L_0x0083:
            ...
            androidx.fragment.app.FragmentTransaction$Op r7 = (androidx.fragment.app.FragmentTransaction.C0288Op) r7
        ...
        L_0x00e3:
            ...
            androidx.fragment.app.FragmentTransaction$Op r9 = (androidx.fragment.app.FragmentTransaction.C0288Op) r9
        ...
        L_0x0101:
            ...
            androidx.fragment.app.FragmentTransaction$Op r8 = (androidx.fragment.app.FragmentTransaction.C0288Op) r8
    ...
    public static Fragment getViewFragment(@NonNull View view) {
        Object tag = view.getTag(C0234R.C0236id.fragment_container_view_tag);
    ...
    private void setVisibleRemovingFragment(@NonNull Fragment fragment) {
        ...
        if (fragmentContainer != null && fragment.getNextAnim() > 0) {
            if (fragmentContainer.getTag(C0234R.C0236id.visible_removing_fragment_view_tag) == null) {
                fragmentContainer.setTag(C0234R.C0236id.visible_removing_fragment_view_tag, fragment);
            }
            ((Fragment) fragmentContainer.getTag(C0234R.C0236id.visible_removing_fragment_view_tag)).setNextAnim(fragment.getNextAnim());
        }
    }
    ...
    public void attachController(@androidx.annotation.NonNull androidx.fragment.app.FragmentHostCallback<?> r3, @androidx.annotation.NonNull androidx.fragment.app.FragmentContainer r4, @androidx.annotation.Nullable final androidx.fragment.app.Fragment r5) {
        ...
        L_0x0061:
            ...
            java.lang.String r0 = ":"
            java.lang.String r4 = com.android.tools.p006r8.GeneratedOutlineSupport.outline18(r4, r5, r0)
            goto L_0x008f
        L_0x008d:
            java.lang.String r4 = ""
        L_0x008f:
            java.lang.String r5 = "FragmentManager:"
            java.lang.String r4 = com.android.tools.p006r8.GeneratedOutlineSupport.outline16(r5, r4)
            java.lang.String r5 = "StartActivityForResult"
            java.lang.String r5 = com.android.tools.p006r8.GeneratedOutlineSupport.outline16(r4, r5)
            ...
            java.lang.String r4 = com.android.tools.p006r8.GeneratedOutlineSupport.outline16(r4, r5)
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        int size;
        int size2;
        String outline16 = GeneratedOutlineSupport.outline16(str, "    ");
        ...
        if (arrayList2 != null && (size = arrayList2.size()) > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                backStackRecord.dump(outline16, printWriter);
            }
        }
        printWriter.print(str);
    ...
    public void putFragment(@NonNull Bundle bundle, @NonNull String str, @NonNull Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(GeneratedOutlineSupport.outline15("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next != null) {
                        ...
                        fragment.mFragmentManager = this;
                        if (isLoggingEnabled(2)) {
                            StringBuilder outline24 = GeneratedOutlineSupport.outline24("restoreSaveState: active (");
                            outline24.append(fragment.mWho);
                            outline24.append("): ");
                            outline24.append(fragment);
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    while (true) {
                        ...
                        if (isLoggingEnabled(2)) {
                            StringBuilder outline25 = GeneratedOutlineSupport.outline25("restoreAllState: back stack #", i, " (index ");
                            outline25.append(instantiate.mIndex);
                            outline25.append("): ");
                            outline25.append(instantiate);
    ...
    public Parcelable saveAllState() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (isLoggingEnabled(2)) {
                    StringBuilder outline25 = GeneratedOutlineSupport.outline25("saveAllState: adding back stack #", i, ": ");
                    outline25.append(this.mBackStack.get(i));
                    Log.v("FragmentManager", outline25.toString());
                }
            }
        }
    ...
    public final void setFragmentResultListener(@NonNull final String str, @NonNull LifecycleOwner lifecycleOwner, @NonNull final FragmentResultListener fragmentResultListener) {
        ...
        if (lifecycle.getCurrentState() != Lifecycle.State.DESTROYED) {
            C02776 r0 = new LifecycleEventObserver() {
    ...
    public void popBackStack(int i, int i2) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline14("Bad id: ", i));
    }
