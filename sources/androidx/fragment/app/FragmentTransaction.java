...
public abstract class FragmentTransaction {
    ...
    public static final class C0288Op {
        public int mCmd;
        ...
        public C0288Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        public C0288Op(int i, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline17("A shared element with the target name '", str, "' has already been added to the transaction."));
                } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline17("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            ...
            outline24.append(" must be a public static class to be  properly recreated from instance state.");
        ...
        if (str != null) {
            ...
            if (str2 == null || str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(GeneratedOutlineSupport.outline19(sb, fragment.mTag, " now ", str));
            }
        }
        if (i != 0) {
            if (i != -1) {
        ...
        addOp(new C0288Op(i2, fragment));
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0288Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0288Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0288Op(8, fragment));
        return this;
    }
