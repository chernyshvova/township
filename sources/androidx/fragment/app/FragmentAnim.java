...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z) {
        ...
        if (!(viewGroup == null || viewGroup.getTag(C0234R.C0236id.visible_removing_fragment_view_tag) == null)) {
            fragment.mContainer.setTag(C0234R.C0236id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    public static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0234R.animator.fragment_open_enter : C0234R.animator.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0234R.animator.fragment_fade_enter : C0234R.animator.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0234R.animator.fragment_close_enter : C0234R.animator.fragment_close_exit;
    }
