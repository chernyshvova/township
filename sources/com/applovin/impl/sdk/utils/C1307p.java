...
public class C1307p {
    /* renamed from: a */
    public static void m2629a(final View view, long j, final Runnable runnable) {
    ...
    /* renamed from: a */
    public static boolean m2630a(int i) {
        return i == 0;
    }

    /* renamed from: a */
    public static boolean m2631a(int i, int i2) {
        return m2630a(i) != m2630a(i2);
    }
    ...
    public static int[] m2632a(int r6, int r7, int r8) {
        /*
            r0 = 2
            r1 = 0
            r2 = 1
        ...
        L_0x0044:
            ...
            goto L_0x007b
        L_0x0047:
            boolean r3 = com.applovin.impl.sdk.utils.C1263g.m2506b()
        ...
        L_0x007b:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.sdk.utils.C1307p.m2632a(int, int, int):int[]");
    }

    /* renamed from: b */
    public static String m2633b(int i) {
        return i == 0 ? "VISIBLE" : i == 4 ? "INVISIBLE" : i == 8 ? "GONE" : String.valueOf(i);
    }

    /* renamed from: b */
    public static void m2634b(final View view, long j, final Runnable runnable) {
