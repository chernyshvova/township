...
public class StringUtils {
    ...
    /* renamed from: a */
    public static final char[] f2426a = "0123456789abcdef".toCharArray();

    /* renamed from: a */
    public static String m2480a(String str, Integer num) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline17("SHA-1 for \"", str, "\" failed."), th);
        }
    }
    ...
    public static String toDigitsOnlyVersionString(String str) {
        ...
        return TextUtils.join(CodelessMatcher.CURRENT_CLASS_NAME, arrayList);
    }
