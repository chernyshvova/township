...
public class InstallConfig {
    ...
    public static class Builder {
        ...
        public boolean enableDefaultFallbackLanguage = true;
        public boolean enableInAppNotification = true;
        public boolean enableInboxPolling = true;
    ...
    public InstallConfig(boolean z, int i, int i2, int i3, boolean z2, boolean z3, String str, boolean z4, boolean z5, int i4, String str2, Map<String, Object> map) {
        this.enableInAppNotification = z;
        this.notificationIcon = i;
