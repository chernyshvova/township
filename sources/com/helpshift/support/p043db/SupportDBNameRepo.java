package com.helpshift.support.p043db;
...
/* renamed from: com.helpshift.support.db.SupportDBNameRepo */
public class SupportDBNameRepo {
    public static final String FAQS_DB_NAME = "faqs_db";
    public static final String ISSUES_DB_NAME = "issues_db";
    public static final String KEYVALUE_DB_NAME = "keyvalue_db";
    public static final String LEGACY_PROFILE_DB_NAME = "legacy_profile_db";
    public static final String LOG_STORE_DB = "log_store_db";
    public static final String NETWORK_DB_NAME = "network_db";
    public static final String SEARCH_DB_NAME = "search_db";
    public static final String SMART_INTENT_DB_NAME = "smart_intent_db";
    public static final String SUPPORT_KV_DB_NAME = "support_kv_db";
