...
public final class Faq implements Parcelable {
    ...
    public static ArrayList<String> mergeSearchTerms(ArrayList<String> arrayList, ArrayList<String> arrayList2) {
    ...
    public boolean equals(Object obj) {
        Faq faq = (Faq) obj;
        if (faq != null && this.qId.equals(faq.qId) && this.title.equals(faq.title) && this.body.equals(faq.body) && this.publish_id.equals(faq.publish_id) && this.language.equals(faq.language) && this.section_publish_id.equals(faq.section_publish_id) && this.is_rtl == faq.is_rtl && this.is_helpful == faq.is_helpful && this.tags.equals(faq.tags) && this.categoryTags.equals(faq.categoryTags)) {
            return true;
        }
        return false;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeByte(this.is_rtl.booleanValue() ? (byte) 1 : 0);
