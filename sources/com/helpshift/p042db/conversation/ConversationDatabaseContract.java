...
import com.helpshift.p042db.conversation.migration.ConversationDbMigration_10_to_11;
import com.helpshift.p042db.conversation.migration.ConversationDbMigration_11_to_12;
import com.helpshift.p042db.conversation.migration.ConversationDbMigration_6_to_7;
import com.helpshift.p042db.conversation.migration.ConversationDbMigration_7_to_8;
import com.helpshift.p042db.conversation.migration.ConversationDbMigration_8_to_9;
import com.helpshift.p042db.conversation.migration.ConversationDbMigration_9_to_10;
...
/* renamed from: com.helpshift.db.conversation.ConversationDatabaseContract */
public class ConversationDatabaseContract implements DatabaseContract {
    ...
    public static final String TAG = "ConversationDatabase";
    ...
    public List<IMigrator> getMigratorsForUpgrade(int i) {
        ...
        if (i >= 6) {
            ...
            if (i <= 11) {
                arrayList.add(new ConversationDbMigration_11_to_12());
            }
        } else {
    ...
    public List<String> getTableNames() {
        return Arrays.asList(new String[]{"actions", ActionCardTable.TABLE_NAME, "messages", ConversationInboxTable.TABLE_NAME, ConversationTable.TABLE_NAME, FaqsTable.TABLE_NAME});
    }
