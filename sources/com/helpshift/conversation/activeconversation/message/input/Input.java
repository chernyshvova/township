...
public class Input {
    ...
    public boolean equals(Object obj) {
        ...
        if (input.required != this.required || !StringUtils.isEqual(input.inputLabel, this.inputLabel) || !StringUtils.isEqual(input.skipLabel, this.skipLabel) || !StringUtils.isEqual(input.botInfo, this.botInfo)) {
            return false;
        }
        return true;
    }
