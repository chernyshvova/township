...
public final class DistinguishedNameParser {
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                StringBuilder outline24 = GeneratedOutlineSupport.outline24("Malformed DN: ");
                outline24.append(this.f3367dn);
            ...
            if (c2 >= '0' && c2 <= '9') {
                ...
                StringBuilder outline242 = GeneratedOutlineSupport.outline24("Malformed DN: ");
                outline242.append(this.f3367dn);
        ...
        StringBuilder outline243 = GeneratedOutlineSupport.outline24("Malformed DN: ");
        outline243.append(this.f3367dn);
    ...
    private char getEscaped() {
        ...
        StringBuilder outline24 = GeneratedOutlineSupport.outline24("Unexpected end of DN: ");
        outline24.append(this.f3367dn);
        throw new IllegalStateException(outline24.toString());
    }
    ...
    private String hexAV() {
        ...
        StringBuilder outline242 = GeneratedOutlineSupport.outline24("Unexpected end of DN: ");
        outline242.append(this.f3367dn);
        throw new IllegalStateException(outline242.toString());
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f3367dn.toCharArray();
