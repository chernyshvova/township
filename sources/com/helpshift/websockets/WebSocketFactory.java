...
public class WebSocketFactory {
    ...
    private WebSocket createWebSocket(boolean z, String str, String str2, int i, String str3, String str4, SocketConnector socketConnector) {
        ...
        String str5 = str2;
        if (str4 != null) {
            str3 = GeneratedOutlineSupport.outline17(str3, "?", str4);
        }
        return new WebSocket(this, z, str, str5, str3, socketConnector);
    }

    public static String determinePath(String str) {
    ...
    public static boolean isSecureConnectionRequired(String str) {
        ...
        } else if ("wss".equalsIgnoreCase(str) || Utility.URL_SCHEME.equalsIgnoreCase(str)) {
            return true;
        } else {
            if ("ws".equalsIgnoreCase(str) || "http".equalsIgnoreCase(str)) {
                return false;
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline16("Bad scheme: ", str));
        }
    }
