...
public final class UnityBanners {
    ...
    public class BannerWrapper extends FrameLayout {
        ...
        public BannerPosition _bannerPosition = BannerPosition.NONE;
    ...
    private void _loadBanner(Activity activity, String str) {
        if (this._currentBannerWrapper == null) {
            BannerAdRefreshView bannerAdRefreshView = new BannerAdRefreshView(activity, str, new UnityBannerSize(UnityBannerSize.BannerSize.STANDARD_WIDTH, 50));
