...
public class UnityAnalytics {
    ...
    public static JSONObject createLevelFail(String str) {
        HashMap outline28 = GeneratedOutlineSupport.outline28("level_index", str);
        HashMap hashMap = new HashMap();
        hashMap.put("custom_params", outline28);
        hashMap.put("ts", Long.valueOf(new Date().getTime()));
    ...
    public static JSONObject createLevelUp(String str) {
        HashMap outline28 = GeneratedOutlineSupport.outline28("new_level_index", str);
        HashMap hashMap = new HashMap();
        hashMap.put("custom_params", outline28);
        hashMap.put("ts", Long.valueOf(new Date().getTime()));
