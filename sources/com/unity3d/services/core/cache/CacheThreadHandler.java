...
public class CacheThreadHandler extends Handler {
    ...
    private void postProcessDownload(long j, String str, File file, long j2, long j3, boolean z, int i, Map<String, List<String>> map) {
        ...
        if (!z) {
            StringBuilder outline24 = GeneratedOutlineSupport.outline24("Unity Ads cache: File ");
            outline24.append(file.getName());
            outline24.append(" of ");
            outline24.append(j2);
            outline24.append(" bytes downloaded in ");
            outline24.append(elapsedRealtime);
            outline24.append("ms");
    ...
    public void handleMessage(Message message) {
        ...
        data.remove("source");
        String string2 = data.getString(AnimatedVectorDrawableCompat.TARGET);
        data.remove(AnimatedVectorDrawableCompat.TARGET);
