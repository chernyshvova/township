...
public class DeviceInfo {
    ...
    public static /* synthetic */ class C18142 {
        ...
        static {
            /*
                ...
                com.unity3d.services.core.api.DeviceInfo$StorageType r1 = com.unity3d.services.core.api.DeviceInfo.StorageType.INTERNAL     // Catch:{ NoSuchFieldError -> 0x000e }
                r1 = 1
                r0[r1] = r1     // Catch:{ NoSuchFieldError -> 0x000e }
            L_0x000e:
                int[] r0 = $SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType     // Catch:{ NoSuchFieldError -> 0x0016 }
                com.unity3d.services.core.api.DeviceInfo$StorageType r1 = com.unity3d.services.core.api.DeviceInfo.StorageType.EXTERNAL     // Catch:{ NoSuchFieldError -> 0x0016 }
                r1 = 0
                r2 = 2
            ...
            L_0x0016:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C18142.<clinit>():void");
        }
    }
    ...
    public static void registerVolumeChangeListener(final Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C18131 r0 = new IVolumeChangeListener() {
                public int _streamType = num.intValue();
