...
public class Cache {
    ...
    public static void getFileContent(String str, String str2, WebViewCallback webViewCallback) {
        ...
        try {
            ...
            webViewCallback.error(cacheError, str, fileIdToFilename, e.getMessage() + RESTClient.COMMA_SEPARATOR + e.getClass().getName());
        }
    }
        ...
        if (cacheDirectory != null) {
            ...
            try {
                ...
                for (File file : listFiles) {
                    ...
                    DeviceLog.debug("Unity Ads cache: found " + substring + RESTClient.COMMA_SEPARATOR + file.length() + " bytes");
