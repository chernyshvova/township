...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            outline24.append("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(computeChecksumIndex));
            toIntArray(Code93Reader.CHARACTER_ENCODINGS[computeChecksumIndex(outline24.toString(), 15)], iArr);
