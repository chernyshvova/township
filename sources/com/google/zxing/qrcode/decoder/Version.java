...
public final class Version {
    ...
    public Version(int i, int[] iArr, ECBlocks... eCBlocksArr) {
        ...
        int i2 = eCBlocksArr[0].ecCodewordsPerBlock;
        int i3 = 0;
        for (ECB ecb : eCBlocksArr[0].ecBlocks) {
