...
public class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public void getPadding(Rect rect) {
        ...
        if (floatingActionButton.compatPadding) {
            float sizeDimension = ((float) floatingActionButton.getSizeDimension()) / 2.0f;
            float elevation = this.view.getElevation() + this.pressedTranslationZ;
            int ceil = (int) Math.ceil((double) ShadowDrawableWrapper.calculateHorizontalPadding(elevation, sizeDimension, false));
            int ceil2 = (int) Math.ceil((double) ShadowDrawableWrapper.calculateVerticalPadding(elevation, sizeDimension, false));
    ...
    public void onPaddingUpdated(Rect rect) {
        ...
        if (FloatingActionButton.this.compatPadding) {
            ...
            FloatingActionButtonImplLollipop.super.setBackgroundDrawable(insetDrawable2);
            return;
        }
        FloatingActionButtonImplLollipop.super.setBackgroundDrawable(this.rippleDrawable);
    }
    ...
    public void setBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        FloatingActionButtonImplLollipop.super.setBackgroundDrawable(rippleDrawable);
    }
