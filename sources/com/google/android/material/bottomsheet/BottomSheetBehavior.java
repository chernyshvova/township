...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(@androidx.annotation.NonNull android.view.View r8, float r9, float r10) {
            ...
            L_0x00eb:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetBehavior.C21182.onViewReleased(android.view.View, float, float):void");
        }
        ...
        public boolean tryCaptureView(@NonNull View view, int i) {
            ...
            if ((i2 != 3 || bottomSheetBehavior.activePointerId != i || (view2 = (View) bottomSheetBehavior.nestedScrollingChildRef.get()) == null || !view2.canScrollVertically(-1)) && (weakReference = BottomSheetBehavior.this.viewRef) != null && weakReference.get() == view) {
                return true;
            }
            return false;
        }
    ...
    public void startSettlingAnimation(View view, int i) {
        ...
        if (i == 4) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline14("Illegal state argument: ", i));
        } else {
            i2 = this.parentHeight;
        }
