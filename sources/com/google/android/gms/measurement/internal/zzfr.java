...
public final class zzfr extends zzgq {
    ...
    public zzfv zza;
    public zzfv zzb;
    public final PriorityBlockingQueue<zzfs<?>> zzc = new PriorityBlockingQueue<>();
    public final BlockingQueue<zzfs<?>> zzd = new LinkedBlockingQueue();
    public final Thread.UncaughtExceptionHandler zze = new zzft(this, "Thread death: Uncaught exception on worker thread");
    public final Thread.UncaughtExceptionHandler zzf = new zzft(this, "Thread death: Uncaught exception on network thread");
