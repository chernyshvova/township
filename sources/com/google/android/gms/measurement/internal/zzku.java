...
public final class zzku extends AbstractSafeParcelable {
    ...
    public zzku(@SafeParcelable.Param(mo17150id = 1) int i, @SafeParcelable.Param(mo17150id = 2) String str, @SafeParcelable.Param(mo17150id = 3) long j, @SafeParcelable.Param(mo17150id = 4) Long l, @SafeParcelable.Param(mo17150id = 5) Float f, @SafeParcelable.Param(mo17150id = 6) String str2, @SafeParcelable.Param(mo17150id = 7) String str3, @SafeParcelable.Param(mo17150id = 8) Double d) {
        this.zzg = i;
        this.zza = str;
        this.zzb = j;
        this.zzc = l;
