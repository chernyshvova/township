...
public abstract class zzu {
    ...
    @VisibleForTesting
    public static Boolean zza(String str, zzbv.zzf zzf2, zzeq zzeq) {
        String str2;
        List<String> list;
    ...
    public static Boolean zza(String str, zzbv.zzf.zzb zzb2, boolean z, String str2, List<String> list, String str3, zzeq zzeq) {
        if (str == null) {
            return null;
        }
    ...
    public static Boolean zza(long j, zzbv.zzd zzd2) {
        try {
            return zza(new BigDecimal(j), zzd2, (double) RoundRectDrawableWithShadow.COS_45);
        } catch (NumberFormatException unused) {
            return null;
        }
    }

    public static Boolean zza(double d, zzbv.zzd zzd2) {
        try {
    ...
    public static Boolean zza(String str, zzbv.zzd zzd2) {
        if (!zzkr.zza(str)) {
            return null;
        }
        try {
            return zza(new BigDecimal(str), zzd2, (double) RoundRectDrawableWithShadow.COS_45);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
