...
public class ProviderInstaller {
    ...
    @GuardedBy("ProviderInstaller.lock")
    public static void zzb(Context context, Context context2, String str) throws GooglePlayServicesNotAvailableException {
        String str2;
        try {
            if (zzc == null) {
    ...
    public static Method zzc(Context context, String str, String str2, Class[] clsArr) throws ClassNotFoundException, NoSuchMethodException {
