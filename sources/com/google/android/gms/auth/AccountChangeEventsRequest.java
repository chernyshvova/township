...
public class AccountChangeEventsRequest extends AbstractSafeParcelable {
    ...
    public AccountChangeEventsRequest(@SafeParcelable.Param(mo17150id = 1) int i, @SafeParcelable.Param(mo17150id = 2) int i2, @SafeParcelable.Param(mo17150id = 3) String str, @SafeParcelable.Param(mo17150id = 4) Account account) {
        this.zze = i;
        this.zzi = i2;
        this.zzg = str;
