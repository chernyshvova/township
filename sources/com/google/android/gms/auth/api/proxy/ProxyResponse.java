...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    public ProxyResponse(@SafeParcelable.Param(mo17150id = 1000) int i, @SafeParcelable.Param(mo17150id = 1) int i2, @SafeParcelable.Param(mo17150id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(mo17150id = 3) int i3, @SafeParcelable.Param(mo17150id = 4) Bundle bundle, @SafeParcelable.Param(mo17150id = 5) byte[] bArr) {
        this.versionCode = i;
