...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getIdToken", mo17147id = 2)
    @NonNull
    public final String zzak;
    @SafeParcelable.Field(getter = "getAccountType", mo17147id = 1)
    @NonNull
    public final String zzr;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(mo17150id = 1) @NonNull String str, @SafeParcelable.Param(mo17150id = 2) @NonNull String str2) {
