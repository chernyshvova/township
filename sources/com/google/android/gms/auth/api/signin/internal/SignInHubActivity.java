...
public class SignInHubActivity extends FragmentActivity {
    public static boolean zzbt = false;
    public boolean zzbu = false;
    public SignInConfiguration zzbv;
    public boolean zzbw;
    public int zzbx;
    public Intent zzby;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if ("com.google.android.gms.auth.NO_IMPL".equals(action)) {
            ...
            SignInConfiguration signInConfiguration = (SignInConfiguration) intent.getBundleExtra(VungleApiImpl.CONFIG).getParcelable(VungleApiImpl.CONFIG);
            ...
            if (!(bundle == null)) {
                ...
                intent2.putExtra(VungleApiImpl.CONFIG, this.zzbv);
                try {
