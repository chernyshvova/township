...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", mo17147id = 2)
    public final String zzbr;
    @SafeParcelable.Field(getter = "getGoogleConfig", mo17147id = 5)
    public GoogleSignInOptions zzbs;

    @SafeParcelable.Constructor
    public SignInConfiguration(@SafeParcelable.Param(mo17150id = 2) String str, @SafeParcelable.Param(mo17150id = 5) GoogleSignInOptions googleSignInOptions) {
