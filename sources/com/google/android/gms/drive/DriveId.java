...
public class DriveId extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "com.google.android.gms.drive.DriveId.RESOURCE_TYPE_UNKNOWN", mo17147id = 5)
    public final int zzaf;
    public volatile String zzag = null;
    @SafeParcelable.Field(mo17147id = 4)
    public final long zzf;
    public volatile String zzh = null;

    @SafeParcelable.Constructor
    public DriveId(@SafeParcelable.Param(mo17150id = 2) String str, @SafeParcelable.Param(mo17150id = 3) long j, @SafeParcelable.Param(mo17150id = 4) long j2, @SafeParcelable.Param(mo17150id = 5) int i) {
        this.zzad = str;
        boolean z = true;
