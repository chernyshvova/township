...
public class AdvertisingIdClient {
    ...
    public final boolean zzc(@Nullable Info info, boolean z, float f, long j, String str, @Nullable Throwable th) {
        ...
        HashMap outline28 = GeneratedOutlineSupport.outline28("app_context", str2);
        if (info != null) {
            if (true != info.isLimitAdTrackingEnabled()) {
                str2 = AppEventsConstants.EVENT_PARAM_VALUE_NO;
            }
            outline28.put("limit_ad_tracking", str2);
            String id = info.getId();
            if (id != null) {
                outline28.put("ad_id_size", Integer.toString(id.length()));
            }
        }
        if (th != null) {
            outline28.put("error", th.getClass().getName());
        }
        outline28.put("tag", "AdvertisingIdClient");
        outline28.put("time_spent", Long.toString(j));
        new zza(this, outline28).start();
        return true;
    }
