...
public final class zzfp<K, V> extends zzfc<K, V> {
    public static final zzfc<Object, Object> zza = new zzfp((Object) null, new Object[0], 0);
    ...
    public static IllegalArgumentException zza(Object obj, Object obj2, Object[] objArr, int i) {
        ...
        return new IllegalArgumentException(GeneratedOutlineSupport.outline20(GeneratedOutlineSupport.outline23(valueOf4.length() + valueOf3.length() + valueOf2.length() + valueOf.length() + 39, "Multiple entries with same key: ", valueOf, "=", valueOf2), " and ", valueOf3, "=", valueOf4));
    }
