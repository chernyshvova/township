...
public final class zzks {
    public static final zzks zza = new zzks(0, new int[0], new Object[0], false);
    public int zzb;
    public int[] zzc;
    public Object[] zzd;
    public int zze;
    ...
    public final int zze() {
        ...
        for (int i4 = 0; i4 < this.zzb; i4++) {
            ...
            if (i7 == 0) {
                ...
                i3 = ((zzks) this.zzd[i4]).zze() + (zzhi.zze(i6) << 1) + i3;
            } else if (i7 == 5) {
    ...
    public static zzks zza(zzks zzks, zzks zzks2) {
