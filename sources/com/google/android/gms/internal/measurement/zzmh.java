...
public final class zzmh implements zzme {
    ...
    public static final zzdh<Long> zzaa;
    public static final zzdh<Long> zzab;
    public static final zzdh<Long> zzac;
    public static final zzdh<Long> zzad;
    public static final zzdh<Long> zzae;
    public static final zzdh<Long> zzaf;
    public static final zzdh<Long> zzag;
    public static final zzdh<Long> zzah;
    public static final zzdh<String> zzai;
    public static final zzdh<Long> zzaj;
    public static final zzdh<Long> zzb;
    public static final zzdh<String> zzc;
    public static final zzdh<String> zzd;
    public static final zzdh<String> zze;
    public static final zzdh<Long> zzf;
    public static final zzdh<Long> zzg;
    public static final zzdh<Long> zzh;
    public static final zzdh<Long> zzi;
    public static final zzdh<Long> zzj;
    public static final zzdh<Long> zzk;
    public static final zzdh<Long> zzl;
    public static final zzdh<Long> zzm;
    public static final zzdh<Long> zzn;
    public static final zzdh<Long> zzo;
    public static final zzdh<Long> zzp;
    public static final zzdh<Long> zzq;
    public static final zzdh<String> zzr;
    public static final zzdh<Long> zzs;
    public static final zzdh<Long> zzt;
    public static final zzdh<Long> zzu;
    public static final zzdh<Long> zzv;
    public static final zzdh<Long> zzw;
    public static final zzdh<Long> zzx;
    public static final zzdh<Long> zzy;
    public static final zzdh<Long> zzz;

    static {
        zzdm zzdm = new zzdm(zzde.zza("com.google.android.gms.measurement"));
        zza = zzdm.zza("measurement.ad_id_cache_time", 10000);
        zzb = zzdm.zza("measurement.config.cache_time", (long) ErrorReportProvider.BATCH_TIME);
        zzc = zzdm.zza("measurement.log_tag", "FA");
        zzd = zzdm.zza("measurement.config.url_authority", "app-measurement.com");
        zze = zzdm.zza("measurement.config.url_scheme", Utility.URL_SCHEME);
        ...
        zzk = zzdm.zza("measurement.alarm_manager.minimum_interval", (long) ConversationController.ACTIVE_ISSUE_NOTIFICATION_COUNT_TIMEOUT);
        zzl = zzdm.zza("measurement.upload.minimum_delay", 500);
        zzm = zzdm.zza("measurement.monitoring.sample_period_millis", (long) ErrorReportProvider.BATCH_TIME);
        zzn = zzdm.zza("measurement.upload.realtime_upload_interval", 10000);
        zzo = zzdm.zza("measurement.upload.refresh_blacklisted_config_interval", (long) UserSettingsManager.TIMEOUT_7D);
        ...
        zzs = zzdm.zza("measurement.upload.stale_data_deletion_interval", (long) ErrorReportProvider.BATCH_TIME);
        zzt = zzdm.zza("measurement.upload.backoff_period", 43200000);
        zzu = zzdm.zza("measurement.upload.initial_upload_delay_time", (long) TooltipCompatHandler.HOVER_HIDE_TIMEOUT_MS);
