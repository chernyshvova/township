...
public abstract class zzdh<T> {
    ...
    @Nullable
    public static volatile zzdp zzb = null;
    public static volatile boolean zzc = false;
    public static final AtomicReference<Collection<zzdh<?>>> zzd = new AtomicReference<>();
    public static zzdq zze = new zzdq(zzdj.zza);
    ...
    public zzdh(zzdm zzdm, String str, T t, boolean z) {
        this.zzj = -1;
        if (zzdm.zza != null) {
            this.zzf = zzdm;
            this.zzg = str;
    ...
    public final T zzc() {
        ...
        L_0x00be:
            ...
            java.lang.Object r2 = r2.zza((java.lang.String) r4)     // Catch:{ all -> 0x0112 }
    ...
    public /* synthetic */ zzdh(zzdm zzdm, String str, Object obj, boolean z, zzdi zzdi) {
        this(zzdm, str, obj, z);
    }
