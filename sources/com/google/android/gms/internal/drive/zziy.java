...
public final class zziy {
    public static int zza(byte[] bArr, int i, zziz zziz) {
        int i2 = i + 1;
        byte b = bArr[i];
        if (b < 0) {
    ...
    public static int zzb(byte[] bArr, int i, zziz zziz) {
        int i2 = i + 1;
        long j = (long) bArr[i];
        if (j >= 0) {
            zziz.zznl = j;
    ...
    public static int zze(byte[] bArr, int i, zziz zziz) throws zzkq {
    ...
    public static int zzc(byte[] bArr, int i, zziz zziz) throws zzkq {
        int zza = zza(bArr, i, zziz);
        int i2 = zziz.zznk;
        if (i2 < 0) {
            throw zzkq.zzdj();
    ...
    public static int zzd(byte[] bArr, int i, zziz zziz) throws zzkq {
        int zza = zza(bArr, i, zziz);
        int i2 = zziz.zznk;
        if (i2 < 0) {
            throw zzkq.zzdj();
    ...
    public static int zza(int i, byte[] bArr, int i2, zziz zziz) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
    ...
    public static int zza(com.google.android.gms.internal.drive.zzmf r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.drive.zziz r10) throws java.io.IOException {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
    ...
    public static int zza(zzmf zzmf, byte[] bArr, int i, int i2, int i3, zziz zziz) throws IOException {
        zzlu zzlu = (zzlu) zzmf;
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzkp<?> zzkp, zziz zziz) {
        zzkl zzkl = (zzkl) zzkp;
    ...
    public static int zza(byte[] bArr, int i, zzkp<?> zzkp, zziz zziz) throws IOException {
        zzkl zzkl = (zzkl) zzkp;
        int zza = zza(bArr, i, zziz);
    ...
    public static int zza(zzmf<?> zzmf, int i, byte[] bArr, int i2, int i3, zzkp<?> zzkp, zziz zziz) throws IOException {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzmy zzmy, zziz zziz) throws zzkq {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zziz zziz) throws zzkq {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
