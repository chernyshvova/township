...
public final class zzeqf implements zzeqo<Bundle> {
    ...
    public zzeqf(boolean z, boolean z2, String str, boolean z3, int i, int i2, int i3) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
