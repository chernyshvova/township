...
public final class zzrh {
    ...
    public zzrh(int i, int i2, float f, float f2, int i3) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = f;
        this.zzd = f2;
    ...
    private final void zzh(short[] sArr, int i, int i2) {
        short[] zzg2 = zzg(this.zzl, this.zzm, i2);
        this.zzl = zzg2;
        int i3 = this.zzb;
        System.arraycopy(sArr, i * i3, zzg2, this.zzm * i3, i3 * i2);
        this.zzm += i2;
    }
    ...
    private final void zzk() {
                ...
                while (true) {
                    ...
                    if (i13 > 0) {
                        ...
                        if (this.zzb == i10 && i15 == i10) {
                            i5 = zzj(sArr, i12, this.zzf, this.zzg);
                        } else {
                            zzi(sArr, i12, i15);
                            int zzj2 = zzj(this.zzi, 0, this.zzf / i15, this.zzg / i15);
                            if (i15 != i10) {
                                int i16 = zzj2 * i15;
                                int i17 = i15 * 4;
                                int i18 = i16 - i17;
                                ...
                                if (this.zzb == i10) {
                                    i5 = zzj(sArr, i12, i18, i19);
                                } else {
                                    zzi(sArr, i12, i10);
                                    i5 = zzj(this.zzi, 0, i18, i19);
                                }
                            } else {
                                i5 = zzj2;
                            }
                        ...
                        if (d > 1.0d) {
                            ...
                            if (f3 >= 2.0f) {
                                ...
                                this.zzr = (int) (((2.0f - f3) * ((float) i23)) / (-1.0f + f3));
                                i7 = i23;
                            }
                            short[] zzg2 = zzg(this.zzl, this.zzm, i7);
                            this.zzl = zzg2;
                            int i24 = i7;
                            short[] sArr3 = sArr2;
                            zzl(i7, this.zzb, zzg2, this.zzm, sArr3, i12, sArr3, i12 + i23);
                            this.zzm += i24;
                            i12 = i23 + i24 + i12;
                        } else {
                            int i25 = i23;
                            ...
                            if (f3 < 0.5f) {
                                ...
                                this.zzr = (int) ((((f3 + f3) - 4.0f) * ((float) i25)) / (f5 - f3));
                                i6 = i25;
                            }
                            int i26 = i25 + i6;
                            short[] zzg3 = zzg(this.zzl, this.zzm, i26);
                            this.zzl = zzg3;
                            int i27 = this.zzb;
                            System.arraycopy(sArr4, i12 * i27, zzg3, this.zzm * i27, i27 * i25);
                            zzl(i6, this.zzb, this.zzl, this.zzm + i25, sArr4, i12 + i25, sArr4, i12);
                            this.zzm += i26;
                            i12 += i6;
                        }
                    }
        ...
        if (f4 != f5 && this.zzm != i9) {
            ...
            int i32 = this.zzm - i9;
            short[] zzg4 = zzg(this.zzn, this.zzo, i32);
            this.zzn = zzg4;
            short[] sArr6 = this.zzl;
            int i33 = this.zzb;
            System.arraycopy(sArr6, i9 * i33, zzg4, this.zzo * i33, i33 * i32);
            this.zzm = i9;
            this.zzo += i32;
            int i34 = 0;
            while (true) {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        int i42 = i41 - (i39 * i30);
                        int i43 = i41 - (i40 * i31);
                        sArr7[(i37 * i36) + i35] = (short) ((((i43 - i42) * s2) + (s * i42)) / i43);
                        i35++;
                    }
                    this.zzq++;
                    this.zzm++;
    ...
    public static void zzl(int i, int i2, short[] sArr, int i3, short[] sArr2, int i4, short[] sArr3, int i5) {
    ...
    public final void zzb(ShortBuffer shortBuffer) {
        ...
        int i2 = remaining / i;
        int i3 = i * i2;
        short[] zzg2 = zzg(this.zzj, this.zzk, i2);
        this.zzj = zzg2;
        shortBuffer.get(zzg2, this.zzk * this.zzb, (i3 + i3) / 2);
        this.zzk += i2;
        zzk();
    }
