...
public final class zzay implements zzm {
    public final Map<String, zzav> zza = new LinkedHashMap(16, 0.75f, true);
    public long zzb = 0;
    ...
    @VisibleForTesting
    public static byte[] zzg(zzaw zzaw, long j) throws IOException {
        long zza2 = zzaw.zza();
        if (j >= 0 && j <= zza2) {
            int i = (int) j;
            if (((long) i) == j) {
    ...
    public static String zzm(zzaw zzaw) throws IOException {
    ...
    private final void zzn(String str, zzav zzav) {
        if (!this.zza.containsKey(str)) {
            ...
            this.zzb = (zzav.zza - this.zza.get(str).zza) + this.zzb;
        }
    ...
    public static int zzp(InputStream inputStream) throws IOException {
    ...
    public final synchronized void zzb(java.lang.String r16, com.google.android.gms.internal.ads.zzl r17) {
        ...
        L_0x0020:
            ...
            return
        L_0x0022:
            java.io.File r3 = r15.zzf(r16)     // Catch:{ all -> 0x01a3 }
            r4 = 1
            r5 = 0
            ...
            com.google.android.gms.internal.ads.zzav r7 = new com.google.android.gms.internal.ads.zzav     // Catch:{ IOException -> 0x016d }
            r7.<init>(r0, r2)     // Catch:{ IOException -> 0x016d }
            r8 = 538247942(0x20150306, float:1.2621791E-19)
            zzh(r6, r8)     // Catch:{ IOException -> 0x0149 }
        ...
        L_0x0048:
            ...
            zzj(r6, r10)     // Catch:{ IOException -> 0x0149 }
            java.util.List<com.google.android.gms.internal.ads.zzu> r8 = r7.zzh     // Catch:{ IOException -> 0x0149 }
            if (r8 == 0) goto L_0x0089
            int r10 = r8.size()     // Catch:{ IOException -> 0x0149 }
            zzh(r6, r10)     // Catch:{ IOException -> 0x0149 }
        ...
        L_0x006e:
            ...
            com.google.android.gms.internal.ads.zzu r10 = (com.google.android.gms.internal.ads.zzu) r10     // Catch:{ IOException -> 0x0149 }
            ...
            goto L_0x006e
        L_0x0089:
            zzh(r6, r5)     // Catch:{ IOException -> 0x0149 }
        L_0x008c:
            ...
            r15.zzn(r0, r7)     // Catch:{ IOException -> 0x016d }
            ...
            goto L_0x01a1
        L_0x00ab:
            boolean r0 = com.google.android.gms.internal.ads.zzao.zzb     // Catch:{ IOException -> 0x016d }
            if (r0 == 0) goto L_0x00b6
            java.lang.String r0 = "Pruning old cache entries."
            java.lang.Object[] r2 = new java.lang.Object[r5]     // Catch:{ IOException -> 0x016d }
            com.google.android.gms.internal.ads.zzao.zza(r0, r2)     // Catch:{ IOException -> 0x016d }
        L_0x00b6:
            long r6 = r1.zzb     // Catch:{ IOException -> 0x016d }
            long r10 = android.os.SystemClock.elapsedRealtime()     // Catch:{ IOException -> 0x016d }
            java.util.Map<java.lang.String, com.google.android.gms.internal.ads.zzav> r0 = r1.zza     // Catch:{ IOException -> 0x016d }
        ...
        L_0x00c7:
            ...
            com.google.android.gms.internal.ads.zzav r8 = (com.google.android.gms.internal.ads.zzav) r8     // Catch:{ IOException -> 0x016d }
            java.lang.String r13 = r8.zzb     // Catch:{ IOException -> 0x016d }
            java.io.File r13 = r15.zzf(r13)     // Catch:{ IOException -> 0x016d }
        ...
        L_0x00f0:
            ...
            com.google.android.gms.internal.ads.zzao.zzb(r9, r10)     // Catch:{ IOException -> 0x016d }
        L_0x0103:
        ...
        L_0x0120:
            ...
            com.google.android.gms.internal.ads.zzao.zza(r2, r0)     // Catch:{ IOException -> 0x016d }
            monitor-exit(r15)
            return
        L_0x0149:
            r0 = move-exception
            ...
            com.google.android.gms.internal.ads.zzao.zzb(r0, r2)     // Catch:{ IOException -> 0x016d }
            r6.close()     // Catch:{ IOException -> 0x016d }
        ...
        L_0x016d:
            ...
            com.google.android.gms.internal.ads.zzao.zzb(r2, r0)     // Catch:{ all -> 0x01a3 }
        L_0x0180:
            com.google.android.gms.internal.ads.zzax r0 = r1.zzc     // Catch:{ all -> 0x01a3 }
            ...
            com.google.android.gms.internal.ads.zzao.zzb(r0, r2)     // Catch:{ all -> 0x01a3 }
            java.util.Map<java.lang.String, com.google.android.gms.internal.ads.zzav> r0 = r1.zza     // Catch:{ all -> 0x01a3 }
            r0.clear()     // Catch:{ all -> 0x01a3 }
            r2 = 0
            r1.zzb = r2     // Catch:{ all -> 0x01a3 }
            r15.zzc()     // Catch:{ all -> 0x01a3 }
            monitor-exit(r15)
            return
        L_0x01a1:
            monitor-exit(r15)
