...
public final /* synthetic */ class zzedf implements DialogInterface.OnClickListener {
    ...
    public zzedf(zzedb zzedb, String str, zzduu zzduu, Activity activity, zzfdh zzfdh, zzl zzl) {
        this.zza = zzedb;
        this.zzb = str;
        this.zzc = zzduu;
        this.zzd = activity;
