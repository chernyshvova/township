...
public final class zzgdh extends zzgdj {
    ...
    public zzgdh(byte[] bArr, int i, int i2) {
        super((zzgdg) null);
    ...
    public final void zzi(int i, zzgcz zzgcz) throws IOException {
        zzl((i << 3) | 2);
        zzl(zzgcz.zzc());
        zzgcz.zzk(this);
    }
    ...
    public final void zzj(byte b) throws IOException {
        try {
            ...
            throw new zzgdi(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e);
        }
    }
    ...
    public final void zzn(long j) throws IOException {
        if (!zzgdj.zzc || this.zzc - this.zzd < 10) {
            while ((j & -128) != 0) {
                byte[] bArr = this.zzb;
                int i = this.zzd;
                this.zzd = i + 1;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzggy.zzp(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
            this.zzd = i4 + 1;
            zzggy.zzp(bArr4, (long) i4, (byte) ((int) j));
        }
    }
    ...
    public final void zzp(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgdi(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzr(String str) throws IOException {
        int i = this.zzd;
        try {
            int zzw = zzgdj.zzw(str.length() * 3);
            int zzw2 = zzgdj.zzw(str.length());
            if (zzw2 == zzw) {
                int i2 = i + zzw2;
                this.zzd = i2;
                int zze = zzghd.zze(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzl((zze - i) - zzw2);
                this.zzd = zze;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzghd.zze(str, bArr, i3, this.zzc - i3);
        } catch (zzghc e) {
            this.zzd = i;
            zzD(str, e);
