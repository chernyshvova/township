...
public final class zzcbl implements Parcelable.Creator<zzcbk> {
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                case 1:
                    ...
                    break;
                case 2:
                    zzcgy = (zzcgy) SafeParcelReader.createParcelable(parcel, readHeader, zzcgy.CREATOR);
                    break;
                case 3:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    zzfao = (zzfao) SafeParcelReader.createParcelable(parcel, readHeader, zzfao.CREATOR);
                    break;
                case 11:
        ...
        return new zzcbk(bundle, zzcgy, applicationInfo, str, arrayList, packageInfo, str2, str3, zzfao, str4);
    }
