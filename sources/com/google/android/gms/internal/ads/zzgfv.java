...
public interface zzgfv {
    ...
    <T> void zzG(List<T> list, zzgga<T> zzgga, zzgdo zzgdo) throws IOException;

    @Deprecated
    <T> void zzH(List<T> list, zzgga<T> zzgga, zzgdo zzgdo) throws IOException;

    void zzI(List<zzgcz> list) throws IOException;
    ...
    <T> T zzo(zzgga<T> zzgga, zzgdo zzgdo) throws IOException;

    @Deprecated
    <T> T zzp(zzgga<T> zzgga, zzgdo zzgdo) throws IOException;

    zzgcz zzq() throws IOException;
