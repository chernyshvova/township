...
public final class zzakq {
    ...
    public final int zzh(int i) {
        ...
        while (true) {
            ...
            int i5 = this.zzb;
            this.zzb = i5 + 1;
            i3 |= (bArr[i5] & Base64.EQUALS_SIGN_ENC) << i4;
        }
        byte[] bArr2 = this.zza;
        int i6 = this.zzb;
        int i7 = (-1 >>> (32 - i)) & (i3 | ((bArr2[i6] & Base64.EQUALS_SIGN_ENC) >> (8 - i2)));
        if (i2 == 8) {
            this.zzc = 0;
            this.zzb = i6 + 1;
        }
    ...
    public final void zzi(byte[] bArr, int i, int i2) {
        ...
        if (i8 != 0) {
            ...
            if (i9 + i8 > 8) {
                ...
                int i10 = this.zzb;
                this.zzb = i10 + 1;
                b3 = (byte) (b3 | ((bArr3[i10] & Base64.EQUALS_SIGN_ENC) << i9));
                bArr[i3] = b3;
                i9 -= 8;
            }
            int i11 = i9 + i8;
