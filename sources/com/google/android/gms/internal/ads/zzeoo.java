...
public final /* synthetic */ class zzeoo implements Callable {
    public static final Callable zza = new zzeoo();

    public final Object call() {
        Bundle bundle = new Bundle();
        if (((Boolean) zzbex.zzc().zzb(zzbjn.zzE)).booleanValue()) {
