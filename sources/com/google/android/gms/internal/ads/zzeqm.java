...
public final class zzeqm implements zzeqp<zzeqo<Bundle>> {
    public final zzfqo zza;
    public final Context zzb;

    public zzeqm(zzfqo zzfqo, Context context) {
        this.zza = zzfqo;
        this.zzb = context;
    }
    ...
    public final /* synthetic */ zzeqo zzc() throws Exception {
        String str = (String) zzbex.zzc().zzb(zzbjn.zzes);
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        try {
            return new zzeql(zzb(this.zzb, new JSONArray(str)));
        } catch (JSONException e) {
            zzcgs.zze("JSON parsing error", e);
            return null;
        }
    }
}
