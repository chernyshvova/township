...
public final class zzdxa implements SensorEventListener {
    ...
    public long zze = zzs.zzj().currentTimeMillis();
    public int zzf = 0;
    public boolean zzg = false;
    public boolean zzh = false;
    @Nullable
    public zzdwz zzi = null;
    @GuardedBy("this")
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzbex.zzc().zzb(zzbjn.zzgk)).booleanValue()) {
            ...
            if (this.zze + ((long) ((Integer) zzbex.zzc().zzb(zzbjn.zzgm)).intValue()) < currentTimeMillis) {
                this.zzf = 0;
            ...
            this.zzd = valueOf;
            if (valueOf.floatValue() > ((Float) zzbex.zzc().zzb(zzbjn.zzgl)).floatValue() + this.zzc) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else {
                if (this.zzd.floatValue() < this.zzc - ((Float) zzbex.zzc().zzb(zzbjn.zzgl)).floatValue()) {
                    this.zzc = this.zzd.floatValue();
                    this.zzg = true;
                }
            }
            ...
            if (this.zzg && this.zzh) {
                ...
                this.zzg = false;
                this.zzh = false;
                zzdwz zzdwz = this.zzi;
                if (zzdwz != null) {
                    if (i == ((Integer) zzbex.zzc().zzb(zzbjn.zzgn)).intValue()) {
                        zzdxo zzdxo = (zzdxo) zzdwz;
                        zzdxo.zzk(new zzdxm(zzdxo), zzdxn.GESTURE);
                    }
                }
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0038, code lost:
        com.google.android.gms.internal.ads.zzcgs.zzi("Flick detection failed to initialize. Failed to obtain gyroscope.");
     */
    ...
    public final void zzb() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.google.android.gms.internal.ads.zzbjf<java.lang.Boolean> r0 = com.google.android.gms.internal.ads.zzbjn.zzgk     // Catch:{ all -> 0x003e }
            com.google.android.gms.internal.ads.zzbjl r1 = com.google.android.gms.internal.ads.zzbex.zzc()     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdxa.zzb():void");
    }
