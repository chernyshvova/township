...
public final class zzj {
    public static Pair<ByteBuffer, Long> zza(RandomAccessFile randomAccessFile) throws IOException {
        ...
        return zze(randomAccessFile, SupportMenu.USER_MASK);
    }
    ...
    public static Pair<ByteBuffer, Long> zze(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
    ...
    public static void zzf(ByteBuffer byteBuffer) {
        if (byteBuffer.order() != ByteOrder.LITTLE_ENDIAN) {
            throw new IllegalArgumentException("ByteBuffer byte order must be little endian");
        }
    }

    public static long zzg(ByteBuffer byteBuffer, int i) {
