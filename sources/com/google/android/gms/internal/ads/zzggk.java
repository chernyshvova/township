...
public class zzggk<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    public final int zza;
    public List<zzggh> zzb = Collections.emptyList();
    public Map<K, V> zzc = Collections.emptyMap();
    public boolean zzd;
    public volatile zzggj zze;
    public Map<K, V> zzf = Collections.emptyMap();

    public /* synthetic */ zzggk(int i, zzggd zzggd) {
        this.zza = i;
    }
    ...
    public final V zzk(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            List<zzggh> list = this.zzb;
            Map.Entry entry = (Map.Entry) it.next();
            list.add(new zzggh(this, (Comparable) entry.getKey(), entry.getValue()));
            it.remove();
        }
        return value;
    }
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzggj(this, (zzggd) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzggk.zzc()) {
            return entrySet().equals(zzggk.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzd(i).equals(zzggk.zzd(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzggk.zzc);
        }
        return true;
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzggh remove = this.zzb.remove(i2 - 1);
            zzn().put(remove.zza(), remove.getValue());
        }
        this.zzb.add(i, new zzggh(this, k, v));
        return null;
    }
}
