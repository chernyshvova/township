...
public abstract class zzgat implements zzgbo {
    public static final int[] zzb = zzi(new byte[]{101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107});
    public int[] zza;
    public final int zzc;

    public zzgat(byte[] bArr, int i) throws InvalidKeyException {
        if (bArr.length == 32) {
            this.zza = zzi(bArr);
            this.zzc = i;
            return;
    ...
    public final void zzd(ByteBuffer byteBuffer, byte[] bArr) throws GeneralSecurityException {
        if (byteBuffer.remaining() - zzc() >= bArr.length) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (i2 == i - 1) {
                    zzgar.zzc(byteBuffer, wrap, zze, remaining % 64);
                } else {
                    zzgar.zzc(byteBuffer, wrap, zze, 64);
                }
            }
            return;
        }
