...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo17147id = 2)
    public final int zzb;
    @SafeParcelable.Field(getter = "getResolution", mo17147id = 3)
    @Nullable
    public final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", mo17147id = 4)
    @Nullable
    ...
    public ConnectionResult(@SafeParcelable.Param(mo17150id = 1) int i, @SafeParcelable.Param(mo17150id = 2) int i2, @SafeParcelable.Param(mo17150id = 3) @Nullable PendingIntent pendingIntent, @SafeParcelable.Param(mo17150id = 4) @Nullable String str) {
        this.zza = i;
        this.zzb = i2;
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        return GeneratedOutlineSupport.outline10(31, "UNKNOWN_ERROR_CODE(", i, ")");
                }
        }
    }
