...
public final class zzb extends Fragment implements LifecycleFragment {
    ...
    public final void addCallback(String str, @NonNull LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline19(new StringBuilder(String.valueOf(str).length() + 59), "LifecycleCallback with tag ", str, " already added to this fragment."));
    }
