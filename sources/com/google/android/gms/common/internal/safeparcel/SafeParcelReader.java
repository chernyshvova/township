...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@RecentlyNonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(GeneratedOutlineSupport.outline9(37, "Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@RecentlyNonNull Parcel parcel) {
        ...
        throw new ParseException(GeneratedOutlineSupport.outline11(54, "Size read is invalid start=", dataPosition, " end=", i), parcel);
    }
    ...
    public static void zza(Parcel parcel, int i, int i2) {
        ...
        if (readSize != i2) {
            ...
            sb.append(" got ");
            sb.append(readSize);
            throw new ParseException(GeneratedOutlineSupport.outline19(sb, " (0x", hexString, ")"), parcel);
        }
    }

    public static void zzb(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
