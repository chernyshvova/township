...
public class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public final class InstallReferrerServiceConnection implements ServiceConnection {
        ...
        public InstallReferrerServiceConnection(InstallReferrerStateListener installReferrerStateListener, C06291 r3) {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            InstallReferrerClientImpl.this.service = IGetInstallReferrerService.Stub.m2722b(iBinder);
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        if (isReady()) {
            ...
            try {
                return new ReferrerDetails(this.service.mo14908c(bundle));
    ...
    public void startConnection(com.android.installreferrer.api.InstallReferrerStateListener r9) {
        ...
        L_0x0083:
            ...
            android.content.Context r5 = r8.mApplicationContext     // Catch:{ SecurityException -> 0x00ab }
