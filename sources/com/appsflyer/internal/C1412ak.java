...
public final class C1412ak {
    ...
    public static synchronized String AFKeystoreWrapper(WeakReference<Context> weakReference) {
        synchronized (C1412ak.class) {
            ...
            if (AFInAppEventParameterName == null) {
                String str2 = null;
                if (weakReference.get() != null) {
                    str2 = C1387af.AFInAppEventType(weakReference.get()).getString("AF_INSTALLATION", (String) null);
                }
                if (str2 != null) {
                    ...
                    try {
                        ...
                        SharedPreferences.Editor edit = C1387af.AFInAppEventType(weakReference.get()).edit();
                ...
                if (AFInAppEventParameterName != null) {
                    AppsFlyerProperties.getInstance().set(ProfileTable.Columns.COLUMN_UID, AFInAppEventParameterName);
                }
            }
    ...
    public static java.lang.String valueOf(java.io.File r6) {
        /*
        ...
        L_0x002c:
            ...
            com.appsflyer.AFLogger.values(r3, r6)     // Catch:{ all -> 0x0028 }
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C1412ak.valueOf(java.io.File):java.lang.String");
    }
}
