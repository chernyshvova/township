...
public class AdvertisementDBAdapter implements DBAdapter<Advertisement> {
    public static final Type CHECKPOINT_LIST_TYPE = new TypeToken<List<Advertisement.Checkpoint>>() {
    }.getType();
    ...
    public static final Type DYNAMIC_EVENTS_AND_URLS_TYPE = new TypeToken<Map<String, ArrayList<String>>>() {
    }.getType();
    public Type cacheableMapType = new TypeToken<Map<String, Pair<String, String>>>() {
    }.getType();
    public Gson gson = new GsonBuilder().create();
    public Type stringArrayType = new TypeToken<String[]>() {
    }.getType();
    public Type stringMapType = new TypeToken<Map<String, String>>() {
    }.getType();
