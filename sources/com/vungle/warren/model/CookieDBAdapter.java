...
public class CookieDBAdapter implements DBAdapter<Cookie> {
    ...
    public Type boolType = new TypeToken<Map<String, Boolean>>() {
    }.getType();
    public Gson gson = new GsonBuilder().create();
    public Type intType = new TypeToken<Map<String, Integer>>() {
    }.getType();
    public Type longType = new TypeToken<Map<String, Long>>() {
    }.getType();
    public Type stringType = new TypeToken<Map<String, String>>() {
    }.getType();
