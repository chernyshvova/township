...
public class CleanupJob implements Job {
    ...
    public CleanupJob(@NonNull Designer designer2, @NonNull Repository repository2, @NonNull AdLoader adLoader2) {
                        ...
                        for (String str : list2) {
                            ...
                            if (advertisement != null) {
                                if (advertisement.getExpireTime() > System.currentTimeMillis() || advertisement.getState() == 2) {
                                    ...
                                    this.adLoader.loadEndlessIfNeeded(placement, placement.getAdSize(), 1000);
                                }
                            }
                        }
                    }
