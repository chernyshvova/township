...
public class CleverCache implements DownloaderCache {
    ...
    public CleverCache(@NonNull CacheManager cacheManager2, @NonNull CachePolicy<File> cachePolicy, @NonNull SizeProvider sizeProvider2, long j) {
    ...
    public synchronized boolean deleteContents(@androidx.annotation.NonNull java.io.File r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            r0 = 1
    ...
    public synchronized File getFile(@NonNull String str) throws IOException {
        ...
        try {
            ...
            VungleLogger.error("CleverCache#getFile; loadAd sequence", "cannot get instance of MessageDigest with algorithm " + Utility.HASH_ALGORITHM_SHA256);
