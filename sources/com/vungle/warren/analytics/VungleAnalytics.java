...
public class VungleAnalytics implements AdAnalytics {
    ...
    public java.lang.String[] ping(@androidx.annotation.NonNull java.lang.String[] r9) {
        /*
            r8 = this;
            int r0 = r9.length
    ...
    /* renamed from: ri */
    public void mo21860ri(JsonObject jsonObject) {
        if (jsonObject != null) {
            this.client.mo21815ri(jsonObject).enqueue(new Callback<JsonObject>() {
