...
public final class AuthenticationTokenClaims implements Parcelable {
    ...
    public static final class Companion {
        ...
        public final AuthenticationTokenClaims createFromJSONObject$facebook_core_release(JSONObject jSONObject) throws JSONException {
            ...
            String nullableString$facebook_core_release3 = getNullableString$facebook_core_release(jSONObject2, "middle_name");
    ...
    private final boolean isValidClaims(JSONObject jSONObject, String str) {
        ...
        try {
            ...
            if (!(optString2.length() == 0) && (Intrinsics.areEqual(new URL(optString2).getHost(), FacebookSdk.FACEBOOK_COM) || Intrinsics.areEqual(new URL(optString2).getHost(), "www.facebook.com"))) {
                ...
                if (!(optString3.length() == 0)) {
                    ...
                    if (Intrinsics.areEqual(optString3, FacebookSdk.getApplicationId())) {
                        long j = (long) 1000;
                        ...
                        if ((optString5.length() == 0) || !Intrinsics.areEqual(optString5, str)) {
                            return false;
                        }
                        return true;
                    }
    ...
    public int hashCode() {
        int outline4 = GeneratedOutlineSupport.outline4(this.sub, (C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.iat) + ((C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.exp) + GeneratedOutlineSupport.outline4(this.nonce, GeneratedOutlineSupport.outline4(this.aud, GeneratedOutlineSupport.outline4(this.iss, GeneratedOutlineSupport.outline4(this.jti, 527, 31), 31), 31), 31)) * 31)) * 31, 31);
