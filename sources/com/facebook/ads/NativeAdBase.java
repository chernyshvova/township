...
@Keep
public abstract class NativeAdBase implements C1513Ad {
    ...
    @Keep
    public interface NativeAdLoadConfigBuilder extends C1513Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface NativeLoadAdConfig extends C1513Ad.LoadAdConfig {
    }
