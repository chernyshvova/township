...
public class VideoUploader {
    ...
    public static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        public Bundle getParameters() {
            Bundle outline5 = GeneratedOutlineSupport.outline5(VideoUploader.PARAM_UPLOAD_PHASE, VideoUploader.PARAM_VALUE_UPLOAD_START_PHASE);
            outline5.putLong("file_size", this.uploadContext.videoSize);
            return outline5;
        }
    ...
    public static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        public Bundle getParameters() throws IOException {
            Bundle outline5 = GeneratedOutlineSupport.outline5(VideoUploader.PARAM_UPLOAD_PHASE, VideoUploader.PARAM_VALUE_UPLOAD_TRANSFER_PHASE);
            outline5.putString(VideoUploader.PARAM_SESSION_ID, this.uploadContext.sessionId);
            outline5.putString(VideoUploader.PARAM_START_OFFSET, this.chunkStart);
            byte[] access$600 = VideoUploader.getChunk(this.uploadContext, this.chunkStart, this.chunkEnd);
            if (access$600 != null) {
                outline5.putByteArray(VideoUploader.PARAM_VIDEO_FILE_CHUNK, access$600);
                return outline5;
            }
    ...
    public static class UploadContext {
        ...
        public UploadContext(ShareVideoContent shareVideoContent, String str, FacebookCallback<Sharer.Result> facebookCallback, GraphRequest.OnProgressCallback onProgressCallback) {
            ...
            if (!Utility.isNullOrEmpty((Collection<?>) shareVideoContent.getPeopleIds())) {
                this.params.putString("tags", TextUtils.join(RESTClient.COMMA_SEPARATOR, shareVideoContent.getPeopleIds()));
            }
    ...
    public static synchronized void uploadAsync(ShareVideoContent shareVideoContent, String str, FacebookCallback<Sharer.Result> facebookCallback, GraphRequest.OnProgressCallback onProgressCallback) throws FileNotFoundException {
        synchronized (VideoUploader.class) {
            if (!initialized) {
