...
public class AppLinkData {
    ...
    public static final String AUTO_APPLINK_FLAG_KEY = "is_auto_applink";
    ...
    public static final String EXTRAS_DEEPLINK_CONTEXT_KEY = "deeplink_context";
    public static final String METHOD_ARGS_REF_KEY = "ref";
    public static final String METHOD_ARGS_TARGET_URL_KEY = "target_url";
    public static final String PROMOTION_CODE_KEY = "promo_code";
    ...
    public static AppLinkData createFromJson(String str) {
        ...
        try {
            ...
            if (jSONObject.getJSONObject("bridge_args").getString("method").equals("applink") && string.equals(SwrveImp.CAMPAIGN_RESPONSE_VERSION)) {
                AppLinkData appLinkData2 = new AppLinkData();
                ...
                if (appLinkData2.arguments.has("target_url")) {
                    Uri parse = Uri.parse(appLinkData2.arguments.getString("target_url"));
    ...
    @Nullable
    public static AppLinkData createFromUri(Uri uri) {
        if (uri == null) {
            return null;
        }
        AppLinkData appLinkData2 = new AppLinkData();
    ...
    @Nullable
    public static JSONObject getAppLinkData(@Nullable Uri uri) {
        Class<AppLinkData> cls = AppLinkData.class;
