                    ...
                    while (true) {
                        ...
                        if (i > 0) {
                            ...
                            while (true) {
                                    ...
                                    while (true) {
                                        ...
                                        if (shape3 > 0) {
                                            ...
                                            while (true) {
                                                ...
                                                int i11 = i10 + 1;
                                                try {
                                                    f = (data[((i8 + i6) * shape3) + (shape2 * shape3 * i2) + i10] * data3[(((i8 * shape3) + i10) * shape5) + i4]) + f;
                                                    if (i11 >= shape3) {
                                                        break;
                                                    }
                                                    i10 = i11;
                                ...
                                data2[(i6 * shape5) + (i * shape5 * i2) + i4] = f;
                                if (i7 >= i) {
                                    break;
                                }
                                i6 = i7;
                    ...
                    if (shape3 > 0) {
                        ...
                        while (true) {
                            ...
                            if (shape2 > 0) {
                                ...
                                while (true) {
                                    int i7 = i6 + 1;
                                    data3[i5] = (data[(i * shape2) + i6] * data2[(i6 * shape3) + i3]) + data3[i5];
                                    if (i7 >= shape2) {
                                        break;
                                    }
                                    i6 = i7;
