...
public final class Http2Connection implements Closeable {
    ...
    public class ReaderRunnable extends NamedRunnable implements Http2Reader.Handler {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:16:? A[ExcHandler: IOException (unused java.io.IOException), SYNTHETIC, Splitter:B:1:0x0004] */
        ...
        public void execute() {
            /*
                ...
                okhttp3.internal.http2.Http2Reader r2 = r4.reader     // Catch:{ IOException -> 0x0022, all -> 0x001f }
                r2.readConnectionPreface(r4)     // Catch:{ IOException -> 0x0022, all -> 0x001f }
            L_0x0009:
                okhttp3.internal.http2.Http2Reader r2 = r4.reader     // Catch:{ IOException -> 0x0022, all -> 0x001f }
                r3 = 0
                boolean r2 = r2.nextFrame(r3, r4)     // Catch:{ IOException -> 0x0022, all -> 0x001f }
                if (r2 == 0) goto L_0x0013
                goto L_0x0009
            L_0x0013:
                okhttp3.internal.http2.ErrorCode r2 = okhttp3.internal.http2.ErrorCode.NO_ERROR     // Catch:{ IOException -> 0x0022, all -> 0x001f }
                okhttp3.internal.http2.ErrorCode r0 = okhttp3.internal.http2.ErrorCode.CANCEL     // Catch:{ IOException -> 0x0022, all -> 0x001d }
            ...
            L_0x002d:
                ...
                r3.close(r2, r1)     // Catch:{ IOException -> 0x0032 }
            L_0x0032:
                okhttp3.internal.http2.Http2Reader r1 = r4.reader
    ...
    public Http2Connection(Builder builder) {
        ...
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor = new ScheduledThreadPoolExecutor(1, new ThreadFactory(Util.format("OkHttp %s Writer", this.hostname), false) {
            public java.lang.Thread newThread(
/*
Method generation error in method: okhttp3.internal.Util.2.newThread(java.lang.Runnable):java.lang.Thread, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: okhttp3.internal.Util.2.newThread(java.lang.Runnable):java.lang.Thread, class status: UNLOADED
...
*/
        ...
        this.pushExecutor = new ThreadPoolExecutor(0, 1, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactory(Util.format("OkHttp %s Push Observer", this.hostname), true) {
            /*  JADX ERROR: Method generation error
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: okhttp3.internal.Util.2.newThread(java.lang.Runnable):java.lang.Thread, class status: UNLOADED
                	...
                	at jadx.core.dex.nodes.ClassNode.decompile(ClassNode.java:273)
                */
            /*  JADX ERROR: Method generation error: Method args not loaded: okhttp3.internal.Util.2.newThread(java.lang.Runnable):java.lang.Thread, class status: UNLOADED
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: okhttp3.internal.Util.2.newThread(java.lang.Runnable):java.lang.Thread, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
...
*/
    ...
    public static void access$000(Http2Connection http2Connection) {
        if (http2Connection != null) {
            ErrorCode errorCode = ErrorCode.PROTOCOL_ERROR;
            try {
                http2Connection.close(errorCode, errorCode);
    ...
    public void writeData(int r9, boolean r10, okio.Buffer r11, long r12) throws java.io.IOException {
        ...
        L_0x0030:
            long r3 = r8.bytesLeftInWriteWindow     // Catch:{ all -> 0x0056 }
            ...
            int r3 = r3.maxFrameSize     // Catch:{ all -> 0x0056 }
