...
public final class PlatformImplementationsKt {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v7, resolved type: kotlin.internal.PlatformImplementations} */
    ...
    static {
        /*
            ...
            r3 = 46
            r4 = 0
            int r2 = kotlin.text.CharsKt__CharKt.indexOf$default((java.lang.CharSequence) r1, (char) r3, (int) r4, (boolean) r4, (int) r2)
        ...
        L_0x001d:
            int r6 = r2 + 1
            r7 = 4
            int r3 = kotlin.text.CharsKt__CharKt.indexOf$default((java.lang.CharSequence) r1, (char) r3, (int) r6, (boolean) r4, (int) r7)
        ...
        L_0x0049:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r6)     // Catch:{ ClassNotFoundException -> 0x0096 }
            kotlin.internal.PlatformImplementations r2 = (kotlin.internal.PlatformImplementations) r2     // Catch:{ ClassCastException -> 0x0067 }
            goto L_0x0161
        L_0x0067:
            r7 = move-exception
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ ClassNotFoundException -> 0x0096 }
        ...
        L_0x0096:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r6)     // Catch:{ ClassNotFoundException -> 0x00d6 }
            kotlin.internal.PlatformImplementations r2 = (kotlin.internal.PlatformImplementations) r2     // Catch:{ ClassCastException -> 0x00a7 }
            goto L_0x0161
        L_0x00a7:
            r7 = move-exception
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ ClassNotFoundException -> 0x00d6 }
        ...
        L_0x00d7:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r6)     // Catch:{ ClassNotFoundException -> 0x011c }
            r2 = r1
            kotlin.internal.PlatformImplementations r2 = (kotlin.internal.PlatformImplementations) r2     // Catch:{ ClassCastException -> 0x00ed }
            goto L_0x0161
        L_0x00ed:
            r2 = move-exception
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r3)     // Catch:{ ClassNotFoundException -> 0x011c }
        ...
        L_0x011c:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r6)     // Catch:{ ClassNotFoundException -> 0x015c }
            r2 = r1
            kotlin.internal.PlatformImplementations r2 = (kotlin.internal.PlatformImplementations) r2     // Catch:{ ClassCastException -> 0x012d }
            goto L_0x0161
        L_0x012d:
            r2 = move-exception
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r3)     // Catch:{ ClassNotFoundException -> 0x015c }
